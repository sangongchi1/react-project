! function (e, t) {
  ...
  function Ce() {
    if ((Ir.isSupport() && "true" === sessionStorage.getItem("sensorsdata_jssdk_debug") || Ur.show_log) && (!r(arguments[0]) || Ur.show_log !== !0 && "string" !== Ur.show_log && Ur.show_log !== !1 || (arguments[0] = U(arguments[0])), "object" == typeof console && console.log)) try {
  ...
  function Oe(e) {
    return 0 === e.indexOf(Rr) ? (e = e.substring(Rr.length), e = ve(e)) : 0 === e.indexOf(Hr) && (e = e.substring(Hr.length), e = A(e)), e
  }
  ...
  function xe(e) {
    ...
    var t = e.target,
      ...
      i = {};
    return i.$element_type = r, i.$element_name = t.getAttribute("name"), i.$element_id = t.getAttribute("id"), i.$element_class_name = "string" == typeof t.className ? t.className : null, i.$element_target_url = t.getAttribute("href"), i.$element_content = qe(t, r), i = Ae(i), i.$url = Z(), i.$url_path = Y(), i.$title = document.title, i
  }
  ...
  function rr() {
    Ti.isSeachHasKeyword() ? Ti.hasKeywordHandle() : window.parent !== self && Ai.isSearchHasKeyword() ? Ai.verifyVtrackMode() : Ti.isWindowNameHasKeyword() ? Ti.windowNameHasKeywordHandle() : Ti.isStorageHasKeyword() ? Ti.storageHasKeywordHandle() : window.parent !== self && Ai.isStorageHasKeyword() ? Ai.verifyVtrackMode() : (tr(), Ai.notifyUser())
  }
  ...
  function ur(t) {
    return r(t) ? (k(t, function (r, i) {
      ...
      d(r) || ue(r) || I(r) || ae(r) || v(r) || e(r) || "$option" === i || (Ce("\u60a8\u7684\u6570\u636e-", i, r, "-\u683c\u5f0f\u4e0d\u6ee1\u8db3\u8981\u6c42\uff0c\u6211\u4eec\u5df2\u7ecf\u5c06\u5176\u5220\u9664"), delete t[i])
    }), t) : t
  }
          ...
          if (s("json-stringify") && !s("date-serialization")) {
            ...
            var x = "\\u00",
              ...
              U = function (e, t, r, i, n, s, o) {
                ...
                if (a(function () {
                    l = t[e]
                  }), "object" == typeof l && l && (l.getUTCFullYear && v.call(l) == w && l.toJSON === d.prototype.toJSON ? l = A(l) : "function" == typeof l.toJSON && (l = l.toJSON(e))), r && (l = r.call(t, e, l)), l == h) return l === h ? l : "null";
  ...
  var Ci = {
    ...
    Ti = {
      ...
      hasKeywordHandle: function () {
        ...
        if (ai.setNotice(i), Ir.isSupport())
      ...
      windowNameHasKeywordHandle: function () {
        ...
        var t = JSON.parse(window.name),
          ...
          i = e("sa-request-type"),
          n = e("sa-request-url");
        ai.setNotice(n), Ir.isSupport() && (null !== n && sessionStorage.setItem("sensors_heatmap_url", n), sessionStorage.setItem("sensors_heatmap_id", r), null !== i ? "1" === i || "2" === i || "3" === i ? sessionStorage.setItem("sensors_heatmap_type", i) : i = null : i = null !== sessionStorage.getItem("sensors_heatmap_type") ? sessionStorage.getItem("sensors_heatmap_type") : null), Ti.isReady(r, i)
      }
    },
    Ai = {
      isStorageHasKeyword: function () {
      ...
      messageListener: function (e) {
        ...
        if ("v-track-mode" === e.data.type) {
          ...
          window.removeEventListener("message", Ai.messageListener, !1)
        }
      },
      removeMessageHandle: function () {
        window.removeEventListener && window.removeEventListener("message", Ai.messageListener, !1)
      },
      verifyVtrackMode: function () {
        window.addEventListener && window.addEventListener("message", Ai.messageListener, !1), Ai.postMessage()
      },
      ...
      notifyUser: function () {
        ...
        window.addEventListener && window.addEventListener("message", e, !1), Ai.postMessage()
      }
    },
    Ii = ["setItem", "deleteItem", "getAppStatus", "track", "quick", "register", "registerPage", "registerOnce", "trackSignup", "setProfile", "setOnceProfile", "appendProfile", "incrementProfile", "deleteProfile", "unsetProfile", "identify", "login", "logout", "trackLink", "clearAllRegister", "clearPageRegister", "bind", "unbind", "loginWithKey"],
    xi = {
  ...
  sr.prototype.process = function (e, t) {
    ...
    if (t)
      for (var i in t) {
        var n = t[i];
        if (n && r(n) && e(n.entry)) {
          ue(n.priority) || (n.priority = Number.MAX_VALUE), this.registeredInterceptors[i] || (this.registeredInterceptors[i] = []);
  ...
  try {
    br.modules = {}, br.modules.Amp = function () {
      ...
      function () {
        ...
        e.getPart = function (e) {
          ...
          if (n) {
            var s, o = n[1] || "",
              l = n[2] || "",
              c = n[3] || "",
              u = "_sasdk=" + this.getCurrenId(),
              d = function (e) {
                var t = e.split("&"),
                  i = [];
                return r._.each(t, function (e) {
                  e.indexOf("_sasdk=") > -1 ? i.push(u) : i.push(e)
                }), i.join("&")
              };
            if (this.getPartHash(e)) {
              s = c.indexOf("_sasdk");
              var p = c.indexOf("?");
              a = p > -1 ? s > -1 ? o + l + "#" + c.substring(1, s) + d(c.substring(s, c.length)) : o + l + c + "&" + u : o + l + "#" + c.substring(1) + "?" + u
            } else {
              s = l.indexOf("_sasdk");
              var f = /^\?(\w)+/.test(l);
              a = f ? s > -1 ? o + "?" + d(l.substring(1)) + c : o + l + "&" + u + c : o + "?" + u + c
            }
            return t && (t.href = a), a
          }
        }, e.getUrlId = function () {
        ...
        function e() {
          if (i = window.SensorsData_iOS_JS_Bridge && window.SensorsData_iOS_JS_Bridge.sensorsdata_app_server_url, n = function () {
              return window.webkit && window.webkit.messageHandlers && window.webkit.messageHandlers.sensorsdataNativeTracker
            }, a && !a.bridge.activeBridge && n() && n().postMessage) {
            if (a.bridge.activeBridge = l, a.para.app_js_bridge && !a.para.app_js_bridge.is_mui && (a.bridge.is_verify_success = i && a.bridge.validateAppUrl(i)), a.bridge.bridge_info = {
                touch_app_bridge: !0,
                platform: "ios",
                verify_success: a.bridge.is_verify_success ? "success" : "fail",
                support_two_way_call: !0
              }, !a.para.app_js_bridge) return void o("app_js_bridge is not configured, data will not be sent by iOS bridge.");
            a.registerInterceptor("sendStage", {
              send: {
                priority: 0,
                entry: t
              }
            }), o("IOS bridge inits succeed.")
          }
        }

        function t(e, t) {
          if (a.para.app_js_bridge.is_mui) return e;
          var r = e.callback;
          return a.bridge.is_verify_success ? (n() && n().postMessage(JSON.stringify({
            callType: "app_h5_track",
            data: s.extend({
              server_url: a.para.server_url
            }, e.data)
          })), s.isFunction(r) && r(), t.cancellationToken.cancel(), e) : a.para.app_js_bridge.is_send ? (a.debug.apph5({
            data: e.data,
            step: "4.1",
            output: "all"
          }), e) : (s.isFunction(r) && r(), t.cancellationToken.cancel(), e)
        }

        function r(e) {
          var t = e.callType;
          return "page_info" !== t && "visualized_track" !== t || a.bridge.hasVisualModeBridge() ? "sensorsdata_get_app_visual_config" === t ? s.isObject(window.SensorsData_APP_New_H5_Bridge) && window.SensorsData_APP_New_H5_Bridge[t] : n() && n().postMessage(JSON.stringify(e)) : null
        }
        var i, n, a, s, o, l = {
          init: function (t) {
            a = t, s = a && a._, o = a && a.log || console && console.log || function () {}, a.on && a.on("sdkAfterInitPara", e)
          },
          handleCommand: r
        };
        return window.SensorsDataWebJSSDKPlugin && "[object Object]" === Object.prototype.toString.call(window.SensorsDataWebJSSDKPlugin) ? window.SensorsDataWebJSSDKPlugin.IOSBridge = window.SensorsDataWebJSSDKPlugin.IOSBridge || l : window.SensorsDataWebJSSDKPlugin = {
          IOSBridge: l
        }, l
