...
function now() {
  ...
  var r = t.JSON,
    ...
    s = function a(r, i) {
      ...
      var n = r.Number || t.Number,
        ...
        u = r.Math || t.Math,
        p = r.JSON || t.JSON;
      if ("object" == typeof p && p) return i.stringify = p.stringify, i.parse = p.parse, i.runInContext = a, i;
      var g, f = o.prototype,
        _ = f.toString,
        h = f.hasOwnProperty;
        ...
        if ("bug-string-char-index" == e) t = "a" != "a" [0];
          ...
          if ("json-stringify" == e) {
            ...
            c && ((a = function () {
              ...
              c = "0" === r(0) && "0" === r(new n) && '""' == r(new s) && r(_) === g && r(g) === g && r() === g && "1" === r(a) && "[1]" == r([a]) && "[null]" == r([g]) && "null" == r(null) && "[null,null,null]" == r([g, _, null]) && r({
                a: [a, !0, !1, null, "\0\b\n\f\r\t"]
              }) == o && "1" === r(null, a) && "[\n 1,\n 2\n]" == r([1, 2], null, 1)
            }, function () {
              c = !1
          ...
          if ("json-parse" == e) {
            ...
            "function" == typeof u && m(function () {
              0 !== u("0") || u(!1) || (a = u(o), (l = 5 == a.a.length && 1 === a.a[0]) && (m(function () {
                l = !u('"\t"')
              }), l && m(function () {
                l = 1 !== u("01")
              }), l && m(function () {
      ...
      if (m(function () {
        ...
        var S = y("bug-string-char-index"),
          b = function (t, r) {
            ...
            for (s in (i = function () {
                this.valueOf = 0
              }).prototype.valueOf = 0, n = new i) h.call(n, s) && a++;
            return i = n = null, a ? b = function (e, t) {
              var r, i, n = "[object Function]" == _.call(e);
              for (r in e) n && "prototype" == r || !h.call(e, r) || (i = "constructor" === r) || t(r);
              (i || h.call(e, r = "constructor")) && t(r)
            } : (n = ["valueOf", "toString", "toLocaleString", "propertyIsEnumerable", "isPrototypeOf", "hasOwnProperty", "constructor"], b = function (t, r) {
              var i, s, a = "[object Function]" == _.call(t),
                o = !a && "function" != typeof t.constructor && e[typeof t.hasOwnProperty] && t.hasOwnProperty || h;
              for (i in t) a && "prototype" == i || !o.call(t, i) || r(i);
              for (s = n.length; i = n[--s];) o.call(t, i) && r(i)
            }), b(t, r)
          };
        if (!y("json-stringify") && !y("date-serialization")) {
          var w = {
            ...
            P = function (e) {
              var t, r, i, n, s, a, o, d, c;
              if (v) t = function (e) {
                r = e.getUTCFullYear(), i = e.getUTCMonth(), n = e.getUTCDate(), a = e.getUTCHours(), o = e.getUTCMinutes(), d = e.getUTCSeconds(), c = e.getUTCMilliseconds()
              };
              else {
                var l = u.floor,
                ...
                t = function (e) {
                  for (n = l(e / 864e5), r = l(n / 365.2425) + 1970 - 1; g(r + 1, 0) <= n; r++);
                  for (i = l((n - g(r, 0)) / 30.42); g(r, i + 1) <= n; i++);
                  n = 1 + n - g(r, i), a = l((s = (e % 864e5 + 864e5) % 864e5) / 36e5) % 24, o = l(s / 6e4) % 60, d = l(s / 1e3) % 60, c = s % 1e3
                }
              }
              return (P = function (e) {
                return e > -1 / 0 && e < 1 / 0 ? (t(e), e = (r <= 0 || r >= 1e4 ? (r < 0 ? "-" : "+") + k(6, r < 0 ? -r : r) : k(4, r)) + "-" + k(2, i + 1) + "-" + k(2, n) + "T" + k(2, a) + ":" + k(2, o) + ":" + k(2, d) + "." + k(3, c) + "Z", r = i = n = a = o = d = c = null) : e = null, e
              })(e)
            };
          if (y("json-stringify") && !y("date-serialization")) {
            function O(e) {
            ...
            var D = function (e) {
              ...
              C = /[\x00-\x1f\x22\x5c]/g,
              E = function (e) {
                return C.lastIndex = 0, '"' + (C.test(e) ? e.replace(C, D) : e) + '"'
              },
              I = function (e, t, r, i, n, s, a) {
                var o, c, u, p, f, h, v, y, S;
                if (m(function () {
                    o = t[e]
                  }), "object" == typeof o && o && (o.getUTCFullYear && "[object Date]" == _.call(o) && o.toJSON === d.prototype.toJSON ? o = P(o) : "function" == typeof o.toJSON && (o = o.toJSON(e))), r && (o = r.call(t, e, o)), o == g) return o === g ? o : "null";
                ...
                if ("object" == typeof o) {
                  for (v = a.length; v--;)
                    if (a[v] === o) throw l();
                  if (a.push(o), p = [], y = s, s += n, "[object Array]" == u) {
                    for (h = 0, v = o.length; h < v; h++) f = I(h, o, r, i, n, s, a), p.push(f === g ? "null" : f);
                    S = p.length ? n ? "[\n" + s + p.join(",\n" + s) + "\n" + y + "]" : "[" + p.join(",") + "]" : "[]"
                  } else b(i || o, function (e) {
                    var t = I(e, o, r, i, n, s, a);
                    t !== g && p.push(E(e) + ":" + (n ? " " : "") + t)
                  }), S = p.length ? n ? "{\n" + s + p.join(",\n" + s) + "\n" + y + "}" : "{" + p.join(",") + "}" : "{}";
                  return a.pop(), S
                }
            ...
            i.stringify = function (t, r, i) {
              var n, s, a, o;
              if (e[typeof r] && r)
                if ("[object Function]" == (o = _.call(r))) s = r;
                else if ("[object Array]" == o) {
                a = {};
                for (var d, c = 0, l = r.length; c < l;) d = r[c++], "[object String]" != (o = _.call(d)) && "[object Number]" != o || (a[d] = 1)
              }
              if (i)
              ...
              return I("", ((d = {})[""] = t, d), s, a, n, "", [])
            }
          }
        }
        if (!y("json-parse")) {
          var N, L, $ = s.fromCharCode,
            A = {
              92: "\\",
              34: '"',
              47: "/",
            ...
            x = function () {
              for (var e, t, r, i, n, s = L, a = s.length; N < a;) switch (n = s.charCodeAt(N)) {
                case 9:
                case 10:
                case 13:
                case 32:
                ...
                case 58:
                case 44:
                  return e = S ? s.charAt(N) : s[N], N++, e;
                case 34:
                  for (e = "@", N++; N < a;)
                    if ((n = s.charCodeAt(N)) < 32) T();
                    else if (92 == n) switch (n = s.charCodeAt(++N)) {
                    case 92:
                    case 34:
                    case 47:
                    case 98:
                    ...
                    case 114:
                      ...
                      break;
                    case 117:
                      for (t = ++N, r = N + 4; N < r; N++)(n = s.charCodeAt(N)) >= 48 && n <= 57 || n >= 97 && n <= 102 || n >= 65 && n <= 70 || T();
                      e += $("0x" + s.slice(t, N));
                      break;
                    default:
                      T()
                    ...
                    if (34 == n) break;
                    for (n = s.charCodeAt(N), t = N; n >= 32 && 92 != n && 34 != n;) n = s.charCodeAt(++N);
                    e += s.slice(t, N)
                  }
                  if (34 == s.charCodeAt(N)) return N++, e;
                  T();
                default:
                  if (t = N, 45 == n && (i = !0, n = s.charCodeAt(++N)), n >= 48 && n <= 57) {
                    for (48 == n && (n = s.charCodeAt(N + 1)) >= 48 && n <= 57 && T(), i = !1; N < a && (n = s.charCodeAt(N)) >= 48 && n <= 57; N++);
                    if (46 == s.charCodeAt(N)) {
                      for (r = ++N; r < a && !((n = s.charCodeAt(r)) < 48 || n > 57); r++);
                      r == N && T(), N = r
                    }
                    if (101 == (n = s.charCodeAt(N)) || 69 == n) {
                      for (43 != (n = s.charCodeAt(++N)) && 45 != n || N++, r = N; r < a && !((n = s.charCodeAt(r)) < 48 || n > 57); r++);
                      r == N && T(), N = r
                    }
                    return +s.slice(t, N)
                  }
                  ...
                  if ("fals" == o && 101 == s.charCodeAt(N + 4)) return N += 5, !1;
            ...
            U = function (e) {
              ...
              if ("$" == e && T(), "string" == typeof e) {
                ...
                if ("[" == e) {
                  for (t = [];
                    "]" != (e = x());) r ? "," == e ? "]" == (e = x()) && T() : T() : r = !0, "," == e && T(), t.push(U(e));
                  return t
                }
                if ("{" == e) {
                  for (t = {};
                    "}" != (e = x());) r ? "," == e ? "}" == (e = x()) && T() : T() : r = !0, "," != e && "string" == typeof e && "@" == (S ? e.charAt(0) : e[0]) && ":" == x() || T(), t[e.slice(1)] = U(x());
                  return t
                }
                T()
              }
          ...
          i.parse = function (e, t) {
            var r, i;
            return N = 0, L = "" + e, r = U(x()), "$" != x() && T(), N = L = null, t && "[object Function]" == _.call(t) ? J(((i = {})[""] = r, i), "", t) : r
          }
        }
      }
      return i.runInContext = a, i
    }(t, t.JSON3 = {
      noConflict: function () {
        return n || (n = !0, t.JSON = r, t.JSON3 = i, r = i = null), s
      }
    });
  t.JSON = {
    parse: s.parse,
  ...
  function (e) {
    if (e.atob) try {
      ...
      e.btoa = function (e) {
        e = String(e);
        for (var t, r, n, s, a = "", o = 0, d = e.length % 3; o < e.length;) {
          if ((r = e.charCodeAt(o++)) > 255 || (n = e.charCodeAt(o++)) > 255 || (s = e.charCodeAt(o++)) > 255) return "";
          a += i.charAt((t = r << 16 | n << 8 | s) >> 18 & 63) + i.charAt(t >> 12 & 63) + i.charAt(t >> 6 & 63) + i.charAt(63 & t)
        }
        return d ? a.slice(0, d - 3) + "===".substring(d) : a
      }, e.atob = function (e) {
        if (e = String(e).replace(/[\t\n\f\r ]+/g, ""), !n.test(e)) return "";
        e += "==".slice(2 - (3 & e.length));
        for (var t, r, s, a = "", o = 0; o < e.length;) t = i.indexOf(e.charAt(o++)) << 18 | i.indexOf(e.charAt(o++)) << 12 | (r = i.indexOf(e.charAt(o++))) << 6 | (s = i.indexOf(e.charAt(o++))), a += 64 === r ? String.fromCharCode(t >> 16 & 255) : 64 === s ? String.fromCharCode(t >> 16 & 255, t >> 8 & 255) : String.fromCharCode(t >> 16 & 255, t >> 8 & 255, 255 & t);
        return a
      }
    }
  }(window);
  ...
  for (var t = {}, r = (e = e || "").substring(1).split("&"), i = 0; i < r.length; i++) {
    ...
    if (-1 !== n) {
      var s = r[i].substring(0, n),
        a = r[i].substring(n + 1);
      s = _decodeURIComponent(s), a = _decodeURIComponent(a), t[s] = a
    }
  }
  return t
}
...
function urlParse(e) {
  ...
  return t.prototype.setUrl = function (e) {
    ...
    var r = e.split("#"),
      i = r[0],
      n = r.slice(1).join("#");
    for (var s in t = this._regex.exec(i), this._fields) "undefined" != typeof t[this._fields[s]] && (this._values[s] = t[this._fields[s]]);
...
ConcurrentStorage.prototype.get = function (e, t, r, i) {
  ...
  _localStorage.set(n, JSON.stringify({
    ...
    (s = safeJSONParse(_localStorage.get(n)) || {
      randomNum: 0,
      expireTime: 0
    }) && s.randomNum === a ? (i(_localStorage.get(e)), _localStorage.remove(e), _localStorage.remove(n)) : i(null)
  }, r)
  ...
  _localStorage.set(s, JSON.stringify({
    randomNum: o,
    expireTime: now() + r
  })), setTimeout(function () {
    (a = safeJSONParse(_localStorage.get(s)) || {
      randomNum: 0,
      expireTime: 0
...
var UUID = function () {
  ...
  return function () {
    ...
    var r = e() + "-" + getRandom().toString(16).replace(".", "") + "-" + function () {
      ...
      for (e = 0; e < r.length; e++) t = r.charCodeAt(e), i.unshift(255 & t), i.length >= 4 && (n = s(n, i), i = []);
...
function isArray(e) {
  return Array.isArray && isFunction(isArray) ? Array.isArray(e) : "[object Array]" === Object.prototype.toString.call(e)
}
...
function addEvent(e, t, r, i) {
  ...
  (function (e, t, r) {
    if (i === undefined && "click" === t && (i = !0), e && e.addEventListener) e.addEventListener(t, function (e) {
      e._getPath = n._getPath, r.call(this, e)
    }, i);
    else {
      var s = "on" + t,
        a = e[s];
      e[s] = function (e, t, r, i) {
        return function (s) {
          if (!(s = s || n(window.event))) return undefined;
          s.target = s.srcElement;
          var a, o, d = !0;
          return "function" == typeof r && (a = r(s)), o = t.call(e, s), "beforeunload" !== i ? (!1 !== a && !1 !== o || (d = !1), d) : void 0
        }
      }(e, r, a, t)
    }
...
DomElementInfo.prototype = {
  ...
  attr: function (e, t) {
    return "string" == typeof e && isUndefined(t) ? this.ele.getAttribute(e) : ("string" == typeof e && (t = String(t), this.ele.setAttribute(e, t)), this)
  },
  offset: function () {
  ...
  getCssStyle: function (e) {
    ...
    if (t) return t;
    var r = null;
    if ("function" == typeof window.getMatchedCSSRules && (r = window.getMatchedCSSRules(this.ele)), !r || !isArray(r)) return null;
  ...
  getSameTypeSiblings: function () {
    for (var e = this.ele, t = e.parentNode, r = e.tagName.toLowerCase(), i = [], n = 0; n < t.children.length; n++) {
      var s = t.children[n];
      1 === s.nodeType && s.tagName.toLowerCase() === r && i.push(t.children[n])
    }
    return i
  },
  getParents: function () {
...
function each(e, t, r) {
  ...
  if (nativeForEach && e.forEach === nativeForEach) e.forEach(t, r);
    ...
    for (var s in e) hasOwnProperty$2.call(e, s) && t.call(r, e[s], s, e)
}
...
function map(e, t) {
  var r = [];
  return null == e ? r : Array.prototype.map && e.map === Array.prototype.map ? e.map(t) : (each(e, function (e, i, n) {
    r.push(t(e, i, n))
  }), r)
}
...
function bindReady(e, t) {
  ...
  var r = !1,
    ...
    d = a ? "removeEventListener" : "detachEvent",
    c = a ? "" : "on",
    l = function (i) {
      "readystatechange" == i.type && "complete" != n.readyState || (("load" == i.type ? t : n)[d](c + i.type, l, !1), !r && (r = !0) && e.call(t, i.type || i))
    },
    u = function () {
      try {
        s.doScroll("left")
...
var cookie = {
  ...
  set: function (e, t, r, i, n, s, a) {
    ...
    if (0 !== (r = null == r ? 73e3 : r)) {
      var u = new Date;
      "s" === String(r).slice(-1) ? u.setTime(u.getTime() + 1e3 * Number(String(r).slice(0, -1))) : u.setTime(u.getTime() + 24 * r * 60 * 60 * 1e3), d = "; expires=" + u.toGMTString()
    }

    function p(e) {
      return !!e && e.replace(/\r\n/g, "")
    }
    isString(n) && "" !== n && (l = "; SameSite=" + n), s && (c = "; secure");
    var g = "",
      f = "",
      _ = "";
    e && (g = p(e)), t && (f = p(t)), o && (_ = p(o)), g && f && (document.cookie = g + "=" + encodeURIComponent(f) + d + "; path=/" + _ + l + c)
  },
  remove: function (e, t) {
    this.set(e, "1", -1, t)
  },
...
function dfmapping(e) {
  ...
  var s = "";
  for (n = 0; n < e.length; n++) e.charAt(n) in i ? s += i[e.charAt(n)] : s += e.charAt(n);
  return s
}
...
function extend2Lev(e) {
  return each(Array.prototype.slice.call(arguments, 1), function (t) {
    for (var r in t) void 0 !== t[r] && (isObject(t[r]) && isObject(e[r]) ? extend(e[r], t[r]) : e[r] = t[r])
  }), e
}
...
function getCookieTopLevelDomain(e, t) {
  ...
  if (isArray(i) && i.length >= 2 && !/^(\d+\.)+\d+$/.test(r))
    for (var n = "." + i.splice(i.length - 1, 1); i.length > 0;)
      if (n = "." + i.splice(i.length - 1, 1) + n, document.cookie = t + "=true; path=/; domain=" + n, -1 !== document.cookie.indexOf(t + "=true")) {
        var s = new Date;
        return s.setTime(s.getTime() - 1e3), document.cookie = t + "=true; expires=" + s.toGMTString() + "; path=/; SameSite=Lax; domain=" + n, n
      } return ""
}
      ...
      t = function (e, t) {
        ...
        if (0 === e.indexOf("#")) e = e.slice(1), r = document.getElementById(e);
          ...
          for (var o = t.children, d = 0; d < o.length; d++)
            if (isElement(o[d]) && o[d].tagName.toLowerCase() === n && 0 == --a) {
              r = o[d];
              break
            } if (a > 0) return null
        }
...
function getQueryParam(e, t) {
  t = t.replace(/[\[]/, "\\[").replace(/[\]]/, "\\]"), e = _decodeURIComponent(e);
  var r = new RegExp("[\\?&]" + t + "=([^&#]*)").exec(e);
  return null === r || r && "string" != typeof r[1] && r[1].length ? "" : _decodeURIComponent(r[1])
}
...
function isSupportBeaconSend() {
  ...
  if (/Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent)) {
    ...
    "undefined" == typeof t.safari && (t.safari = i[0]), i[0] && (t.qqBuildinBrowser || t.qqBrowser) ? e = !1 : i[0] && i[0] < 13 ? (t.chrome > 41 || t.firefox > 30 || t.opera > 25 || t.safari > 12) && (e = !0) : (t.chrome > 41 || t.firefox > 30 || t.opera > 25 || t.safari > 11.3) && (e = !0)
...
function jsonp(e) {
  ...
  e.success = isFunction(e.success) ? e.success : function () {}, e.error = isFunction(e.error) ? e.error : function () {}, e.data = e.data || "";
  ...
  if (r.appendChild(t), isNumber(e.timeout) && (i = setTimeout(function () {
    ...
    }, e.url.indexOf("?") > -1 ? e.url += "&callbackName=" + e.callbackName : e.url += "?callbackName=" + e.callbackName, isObject(e.data)) {
    var s = [];
  ...
  t.onerror = function (s) {
    ...
    window[e.callbackName] = function () {
      logger.log("call jsonp error")
    }, clearTimeout(i), i = null, r.removeChild(t), e.error(s), n = !0
  }, t.src = e.url
}
...
function searchObjDate(e) {
  isObject(e) && each(e, function (t, r) {
...
function throttle(e, t, r) {
  ...
  r || (r = {});
  var d = function () {
    o = !1 === r.leading ? 0 : now(), a = null, s = e.apply(i, n), a || (i = n = null)
  };
  return function () {
    var c = now();
    o || !1 !== r.leading || (o = c);
    var l = t - (c - o);
    return i = this, n = arguments, l <= 0 || l > t ? (a && (clearTimeout(a), a = null), o = c, s = e.apply(i, n), a || (i = n = null)) : a || !1 === r.trailing || (a = setTimeout(d, l)), s
  }
}
...
function sdLog() {
  if ((_sessionStorage.isSupport() && "true" === sessionStorage.getItem("sensorsdata_jssdk_debug") || sdPara.show_log) && (!isObject(arguments[0]) || !0 !== sdPara.show_log && "string" !== sdPara.show_log && !1 !== sdPara.show_log || (arguments[0] = formatJsonString(arguments[0])), "object" == typeof console && console.log)) try {
...
function decrypt(e) {
  return 0 === e.indexOf(flag) ? e = rot13defs(e = e.substring(flag.length)) : 0 === e.indexOf(flag_dfm) && (e = dfmapping(e = e.substring(flag_dfm.length))), e
}

function decryptIfNeeded(e) {
  return !isString(e) || 0 !== e.indexOf(flag) && 0 !== e.indexOf(flag_dfm) || (e = decrypt(e)), e
}

function encrypt(e) {
  return flag_dfm + dfmapping(e)
}
var debug = {
    ...
    apph5: function (e) {
      var t = "app_h5\u6253\u901a\u5931\u8d25-",
        ...
        n = e.step,
        s = e.data || "";
      "all" !== i && "console" !== i || sdLog(r[n]), ("all" === i || "code" === i) && isObject(sdPara.is_debug) && sdPara.is_debug.apph5 && (s.type && "profile" === s.type.slice(0, 7) || (s.properties._jssdk_debug_info = "apph5-" + String(n)))
    },
    ...
    protocol: {
      ...
      serverUrl: function () {
        isString(sdPara.server_url) && "" !== sdPara.server_url && !this.protocolIsSame(sdPara.server_url, location.href) && sdLog("SDK \u68c0\u6d4b\u5230\u60a8\u7684\u6570\u636e\u53d1\u9001\u5730\u5740\u548c\u5f53\u524d\u9875\u9762\u5730\u5740\u7684\u534f\u8bae\u4e0d\u4e00\u81f4\uff0c\u5efa\u8bae\u60a8\u4fee\u6539\u6210\u4e00\u81f4\u7684\u534f\u8bae\u3002\n\u56e0\u4e3a\uff1a1\u3001https \u4e0b\u9762\u53d1\u9001 http \u7684\u56fe\u7247\u8bf7\u6c42\u4f1a\u5931\u8d25\u30022\u3001http \u9875\u9762\u4f7f\u7528 https + ajax \u65b9\u5f0f\u53d1\u6570\u636e\uff0c\u5728 ie9 \u53ca\u4ee5\u4e0b\u4f1a\u4e22\u5931\u6570\u636e\u3002")
      },
      ajax: function (e) {
        if (e === sdPara.server_url) return !1;
        isString(e) && "" !== e && !this.protocolIsSame(e, location.href) && sdLog("SDK \u68c0\u6d4b\u5230\u60a8\u7684\u6570\u636e\u53d1\u9001\u5730\u5740\u548c\u5f53\u524d\u9875\u9762\u5730\u5740\u7684\u534f\u8bae\u4e0d\u4e00\u81f4\uff0c\u5efa\u8bae\u60a8\u4fee\u6539\u6210\u4e00\u81f4\u7684\u534f\u8bae\u3002\u56e0\u4e3a http \u9875\u9762\u4f7f\u7528 https + ajax \u65b9\u5f0f\u53d1\u6570\u636e\uff0c\u5728 ie9 \u53ca\u4ee5\u4e0b\u4f1a\u4e22\u5931\u6570\u636e\u3002")
      }
    }
  },
  source_channel_standard = "utm_source utm_medium utm_campaign utm_content utm_term",
  sdkversion_placeholder = "1.23.5",
...
function parseSuperProperties(e) {
  ...
  isObject(t) && each(t, function (e, i) {
    if (isFunction(e)) try {
      t[i] = e(r), isFunction(t[i]) && (sdLog("\u60a8\u7684\u5c5e\u6027- " + i + " \u683c\u5f0f\u4e0d\u6ee1\u8db3\u8981\u6c42\uff0c\u6211\u4eec\u5df2\u7ecf\u5c06\u5176\u5220\u9664"), delete t[i])
    } catch (n) {
      delete t[i], sdLog("\u60a8\u7684\u5c5e\u6027- " + i + " \u629b\u51fa\u4e86\u5f02\u5e38\uff0c\u6211\u4eec\u5df2\u7ecf\u5c06\u5176\u5220\u9664")
    }
  })
}
...
function getCurrentDomain(e) {
  ...
  switch (typeof t) {
    case "function":
      var r = t();
      return "" === r || "" === trim(r) ? "url\u89e3\u6790\u5931\u8d25" : -1 !== r.indexOf(".") ? r : "url\u89e3\u6790\u5931\u8d25";
    case "string":
      return "" === t || "" === trim(t) ? "url\u89e3\u6790\u5931\u8d25" : -1 !== t.indexOf(".") ? t : "url\u89e3\u6790\u5931\u8d25";
    default:
...
function getEleInfo(e) {
  ...
  var t = e.target,
    ...
    i = {};
  return i.$element_type = r, i.$element_name = t.getAttribute("name"), i.$element_id = t.getAttribute("id"), i.$element_class_name = "string" == typeof t.className ? t.className : null, i.$element_target_url = t.getAttribute("href"), i.$element_content = getElementContent$1(t, r), (i = strip_empty_properties(i)).$url = getURL(), i.$url_path = getURLPath(), i.$title = document.title, i
}
...
function isReferralTraffic(e) {
  return "" === (e = e || document.referrer) || getCookieTopLevelDomain(getHostname(e), domain_test_key) !== getCookieTopLevelDomain(null, domain_test_key)
}

function getReferrer(e, t) {
  return "string" != typeof (e = e || document.referrer) ? "\u53d6\u503c\u5f02\u5e38_referrer\u5f02\u5e38_" + String(e) : (0 !== (e = _decodeURI(e = trim(e))).indexOf("https://www.baidu.com/") || t || (e = e.split("?")[0]), "string" == typeof (e = e.slice(0, sdPara.max_referrer_string_length)) ? e : "")
}
...
function getKeywordFromReferrer(e, t) {
  ...
  if (document && "string" == typeof e) {
    if (0 === e.indexOf("http")) {
      ...
      if (isEmptyObject(n)) return sdPara.preset_properties.search_keyword_baidu && isBaiduTraffic() ? void 0 : "\u672a\u53d6\u5230\u503c";
      var s = null;
      for (var a in r)
        if (i === a && "object" == typeof n)
          if (isArray(s = r[a]))
            ...
            } else if (n[s]) return t ? {
              active: n[s]
            } : n[s];
      return sdPara.preset_properties.search_keyword_baidu && isBaiduTraffic() ? void 0 : "\u672a\u53d6\u5230\u503c"
    }
...
function getWxAdIdFromUrl(e) {
  ...
  return isString(t) && t.length && (n.click_id = 16 == t.length || 18 == t.length ? t : "\u53c2\u6570\u89e3\u6790\u4e0d\u5408\u6cd5", isString(r) && r.length && (n.hash_key = r), isString(i) && i.length && (n.callbacks = i)), n
}
var pageInfo = {
  initPage: function () {
    var e = getReferrer(),
  ...
  campaignParamsStandard: function (e, t) {
    ...
    var r = pageInfo.campaignParams(),
      i = {},
      n = {};
    return each(r, function (r, s, a) {
      -1 !== (" " + source_channel_standard + " ").indexOf(" " + s + " ") ? i[e + s] = a[s] : n[t + s] = a[s]
    }), {
      $utms: i,
      otherUtms: n
    }
...
function getSourceFromReferrer() {
  ...
  var t = "(" + sdPara.source_type.utm.join("|") + ")\\=[^&]+",
    ...
    n = document.referrer || "",
    s = pageInfo.pageProp.url;
  if (s) {
    var a = s.match(new RegExp(t));
    return a && a[0] ? "\u4ed8\u8d39\u5e7f\u544a\u6d41\u91cf" : e(r, n) ? "\u81ea\u7136\u641c\u7d22\u6d41\u91cf" : e(i, n) ? "\u793e\u4ea4\u7f51\u7ad9\u6d41\u91cf" : "" === n ? "\u76f4\u63a5\u6d41\u91cf" : "\u5f15\u8350\u6d41\u91cf"
  }
  return "\u83b7\u53d6url\u5f02\u5e38"
}

function getInputElementValue(e) {
  var t = sdPara.heatmap && "function" == typeof sdPara.heatmap.collect_input && sdPara.heatmap.collect_input(e);
...
function addEvent$1(e, t, r) {
  var i = !(!isObject(sdPara.heatmap) || !sdPara.heatmap.useCapture);
  return isObject(sdPara.heatmap) && "undefined" == typeof sdPara.heatmap.useCapture && "click" === t && (i = !0), addEvent(e, t, r, i)
}
var cookie$1 = {
  get: function (e) {
    return cookie.get(e)
  ...
  set: function (e, t, r, i) {
    var n = "";
    if (i = void 0 === i ? sdPara.cross_subdomain : i) {
      var s = getCurrentDomain(location.href);
      "url\u89e3\u6790\u5931\u8d25" === s && (s = ""), n = s ? "; domain=" + s : ""
    }
    return cookie.set(e, t, r, i, sdPara.set_cookie_samesite, sdPara.is_secure_cookie, n)
  },
  remove: function (e, t) {
    return t = void 0 === t ? sdPara.cross_subdomain : t, cookie.remove(e, t)
  },
  isSupport: function (e, t) {
...
function getNewUserFlagKey(e, t) {
  ...
  if (t = t || location.href, !1 === sdPara.cross_subdomain) {
    ...
    r = "string" == typeof r && "" !== r ? "sajssdk_2015_" + sdPara.sdk_id + e + "_" + r.replace(/\./g, "_") : "sajssdk_2015_root_" + sdPara.sdk_id + e
  } else r = "sajssdk_2015_cross_" + sdPara.sdk_id + e;
  return r
}

function isNewUser() {
  return cookie$1.isSupport() ? null !== cookie$1.get("sensorsdata_is_new_user") || null !== cookie$1.get(getNewUserFlagKey("new_user")) : null !== memory.get(memory.getNewUserFlagMemoryKey("new_user"))
}
...
var memory = {
    ...
    get: function (e) {
      var t = this.data[e];
      return t === undefined ? null : t._expirationTimestamp_ !== undefined ? (new Date).getTime() > t._expirationTimestamp_ ? null : t.value : t
    },
    set: function (e, t, r) {
      if (r) {
        var i = new Date;
  ...
  saNewUser = {
    ...
    setDeviceId: function (e) {
      var t = null,
        r = cookie$1.get("sensorsdata2015jssdkcross" + sd.para.sdk_id),
        i = {};
      null != (r = decryptIfNeeded(r)) && isJSONString(r) && (i = JSON.parse(r)).$device_id && (t = i.$device_id), t = t || e, !0 === sd.para.cross_subdomain ? sd.store.set("$device_id", t) : (i.$device_id = t, i = JSON.stringify(i), sd.para.encrypt_cookie && (i = encrypt(i)), cookie$1.set("sensorsdata2015jssdkcross" + sd.para.sdk_id, i, null, !0)), sd.para.is_track_device_id && (pageInfo.currentProps.$device_id = t)
    },
    storeInitCheck: function () {
      if (sd.is_first_visitor) {
        ...
        cookie$1.isSupport() ? cookie$1.set(getNewUserFlagKey("new_user"), "1", 3600 * t.h + 60 * t.m + t.s + "s") : memory.set(memory.getNewUserFlagMemoryKey("new_user"), "1", 3600 * t.h + 60 * t.m + t.s + "s"), this.is_first_visit_time = !0, this.is_page_first_visited = !0
    ...
    checkIsFirstLatest: function () {
      ...
      if (sd.para.preset_properties.search_keyword_baidu ? isReferralTraffic(document.referrer) && (!isBaiduTraffic() || isObject(r) && r.active ? sd.store._state && sd.store._state.props && (sd.store._state.props.$search_keyword_id && delete sd.store._state.props.$search_keyword_id, sd.store._state.props.$search_keyword_id_type && delete sd.store._state.props.$search_keyword_id_type, sd.store._state.props.$search_keyword_id_hash && delete sd.store._state.props.$search_keyword_id_hash) : (t.$search_keyword_id = getBaiduKeyword.id(), t.$search_keyword_id_type = getBaiduKeyword.type(), t.$search_keyword_id_hash = hashCode53(t.$search_keyword_id))) : sd.store._state && sd.store._state.props && (sd.store._state.props.$search_keyword_id && delete sd.store._state.props.$search_keyword_id, sd.store._state.props.$search_keyword_id_type && delete sd.store._state.props.$search_keyword_id_type, sd.store._state.props.$search_keyword_id_hash && delete sd.store._state.props.$search_keyword_id_hash), sd.store.save(), each(sd.para.preset_properties, function (r, i) {
          ...
          if (i = i.slice(7), r) {
            ...
            if ("utm" !== i && "url\u89e3\u6790\u5931\u8d25" === e) "wx_ad_click_id" === i ? (t._latest_wx_ad_click_id = "url\u7684domain\u89e3\u6790\u5931\u8d25", t._latest_wx_ad_hash_key = "url\u7684domain\u89e3\u6790\u5931\u8d25", t._latest_wx_ad_callbacks = "url\u7684domain\u89e3\u6790\u5931\u8d25") : t["$latest_" + i] = "url\u7684domain\u89e3\u6790\u5931\u8d25";
              ...
              case "referrer":
                ...
                break;
              case "search_keyword":
                getKeywordFromReferrer() ? t.$latest_search_keyword = getKeywordFromReferrer() : isObject(sd.store._state) && isObject(sd.store._state.props) && sd.store._state.props.$latest_search_keyword && delete sd.store._state.props.$latest_search_keyword;
                break;
              case "landing_page":
              ...
              case "wx_ad_click_id":
                ...
                t._latest_wx_ad_click_id = n.click_id, t._latest_wx_ad_hash_key = n.hash_key, t._latest_wx_ad_callbacks = n.callbacks
            }
          } else if ("utm" === i && sd.store._state && sd.store._state.props)
            for (var s in sd.store._state.props)(0 === s.indexOf("$latest_utm") || 0 === s.indexOf("_latest_") && s.indexOf("_latest_wx_ad_") < 0) && delete sd.store._state.props[s];
          else if (sd.store._state && sd.store._state.props && "$latest_" + i in sd.store._state.props) delete sd.store._state.props["$latest_" + i];
          else if ("wx_ad_click_id" == i && sd.store._state && sd.store._state.props && !1 === r) {
        ...
        }), sd.register(t), sd.para.preset_properties.latest_utm) {
        var i = pageInfo.campaignParamsStandard("$latest_", "_latest_"),
          n = i.$utms,
          s = i.otherUtms;
        isEmptyObject(n) || sd.register(n), isEmptyObject(s) || sd.register(s)
      }
    }
  },
  store = {
    ...
    getUnionId: function (e) {
      ...
      return t.login_id && this._state.history_login_id && this._state.history_login_id.name && this._state.history_login_id.name !== sd.IDENTITY_KEY.LOGIN && (t.login_id = this._state.history_login_id.name + "+" + t.login_id), t
    },
    getFirstId: function () {
      return this._state._first_id || this._state.first_id
    },
    initSessionState: function () {
      var e = cookie$1.get("sensorsdata2015session"),
        t = null;
      null !== (e = decryptIfNeeded(e)) && "object" == typeof (t = safeJSONParse(e)) && (this._sessionState = t || {})
    },
    ...
    set: function (e, t) {
      ...
      this._state[e] = t, "first_id" === e ? delete this._state._first_id : "distinct_id" === e && delete this._state._distinct_id, this.save(), "distinct_id" === e && r && sd.events.tempAdd("changeDistinctId", t)
    },
    change: function (e, t) {
      this._state["_" + e] = t
    },
    ...
    setProps: function (e, t) {
      var r = {};
      for (var i in r = t ? e : extend(this._state.props || {}, e)) "string" == typeof r[i] && (r[i] = r[i].slice(0, sd.para.max_referrer_string_length));
      this.set("props", r)
    },
    ...
    clearAllProps: function (e) {
      ...
      if (this._sessionState = {}, isArray(e) && e.length > 0)
        for (t = 0; t < e.length; t++) isString(e[t]) && -1 === e[t].indexOf("latest_") && isObject(this._state.props) && e[t] in this._state.props && delete this._state.props[e[t]];
    ...
    sessionSave: function (e) {
      ...
      sd.para.encrypt_cookie && (t = encrypt(t)), cookie$1.set("sensorsdata2015session", t, 0)
    },
    save: function () {
      var e = JSON.parse(JSON.stringify(this._state));
      delete e._first_id, delete e._distinct_id, e.identities && (e.identities = base64Encode(JSON.stringify(e.identities)));
      var t = JSON.stringify(e);
      sd.para.encrypt_cookie && (t = encrypt(t)), cookie$1.set(this.getCookieName(), t, 73e3, sd.para.cross_subdomain)
    },
    getCookieName: function () {
      ...
      if (!1 === sd.para.cross_subdomain) {
        ...
        e = "string" == typeof e && "" !== e ? "sa_jssdk_2015_" + sd.para.sdk_id + e.replace(/\./g, "_") : "sa_jssdk_2015_root" + sd.para.sdk_id
    ...
    init: function () {
      ...
      var e, t, r = UUID();
      cookie$1.isSupport() && (t = safeJSONParse(e = decryptIfNeeded(e = cookie$1.get(this.getCookieName())))), cookie$1.isSupport() && null !== e && isJSONString(e) && isObject(t) && (!isObject(t) || t.distinct_id) ? (sd.store._state = extend(function (e) {
        var t;
        e.identities && (0 === e.identities.indexOf("\n/") ? e.identities = safeJSONParse(rot13defs(e.identities)) : e.identities = safeJSONParse(base64Decode(e.identities)));
        var r = store.getOriginUnionId(e);
        e.identities && isObject(e.identities) && !isEmptyObject(e.identities) ? e.identities.$identity_anonymous_id && e.identities.$identity_anonymous_id !== r.anonymous_id && (e.identities.$identity_anonymous_id = r.anonymous_id) : (e.identities = {}, e.identities.$identity_anonymous_id = r.anonymous_id, e.identities.$identity_cookie_id = UUID()), e.history_login_id = e.history_login_id || {};
        var i = e.history_login_id.name;
        if (r.login_id)
          if (i && e.identities.hasOwnProperty(i)) {
            if (e.identities[i] !== r.login_id) {
              for (t in e.identities[i] = r.login_id, e.identities) e.identities.hasOwnProperty(t) && "$identity_cookie_id" !== t && t !== i && delete e.identities[t];
              e.history_login_id.value = r.login_id
            }
          } else {
            var n = i || sd.IDENTITY_KEY.LOGIN;
            for (t in e.identities[n] = r.login_id, e.identities) e.identities.hasOwnProperty(t) && "$identity_cookie_id" !== t && t !== n && delete e.identities[t];
            e.history_login_id = {
              name: n,
              value: r.login_id
            }
          ...
          if (e.identities.hasOwnProperty("$identity_login_id") || e.identities.hasOwnProperty(i))
        ...
        return e
      }(t)), sd.store.save()) : (sd.is_first_visitor = !0, function (e) {
        sd.store.set("distinct_id", e), sd.store.set("identities", {
          $identity_cookie_id: e
        }), sd.store.set("history_login_id", {
          name: "",
          value: ""
        })
      }(r)), saNewUser.setDeviceId(r), saNewUser.storeInitCheck(), saNewUser.checkIsFirstLatest()
    },
    saveObjectVal: function (e, t) {
      isString(t) || (t = JSON.stringify(t)), 1 == sd.para.encrypt_cookie && (t = encrypt(t)), _localStorage.set(e, t)
    },
    readObjectVal: function (e) {
      var t = _localStorage.get(e);
      return t ? safeJSONParse(t = decryptIfNeeded(t)) : null
    }
  },
  checkLog = {
    string: function (e) {
  ...
  checkOption = {
    distinct_id: {
      ...
      onComplete: function (e, t, r) {
        return !e && ("emptyString" === r && (t = "Id"), isFunction(checkLog[r]) && checkLog[r](t), "idLength" === r) || e
      }
    },
    event: {
      rules: ["string", "emptyString", "keyLength", "regexTest"],
      onComplete: function (e, t, r) {
        return e || ("emptyString" === r && (t = "eventName"), isFunction(checkLog[r]) && checkLog[r](t)), !0
      }
    },
    propertyKey: {
      rules: ["string", "emptyString", "keyLength", "regexTest"],
      onComplete: function (e, t, r) {
        return e || ("emptyString" === r && (t = "Property key"), isFunction(checkLog[r]) && checkLog[r](t)), !0
      }
    },
    propertyValue: {
      rules: ["voidZero"],
    ...
    properties: function (e) {
      ...
      }) : ruleOption.voidZero(e) && sdLog("properties\u53ef\u4ee5\u6ca1\u6709\uff0c\u4f46\u6709\u7684\u8bdd\u5fc5\u987b\u662f\u5bf9\u8c61"), !0
    },
    propertiesMust: function (e) {
      return e !== undefined && isObject(e) && !isEmptyObject(e) ? this.properties.call(this, e) : sdLog("properties\u5fc5\u987b\u662f\u5bf9\u8c61"), !0
    },
    item_type: {
      rules: ["string", "emptyString", "keyLength", "regexTest"],
      onComplete: function (e, t, r) {
        return e || ("emptyString" === r && (t = "item_type"), isFunction(checkLog[r]) && checkLog[r](t)), !0
      }
    },
    item_id: {
    ...
    loginIdKey: {
      ...
      onComplete: function (e, t, r) {
        return !e && ("emptyString" === r && (t = "login_id_key"), isFunction(checkLog[r]) && checkLog[r](t), "keyLength" === r) || e
      }
    },
    bindKey: {
      rules: ["string", "emptyString", "keyLength", "regexTest", "reservedBind"],
      onComplete: function (e, t, r) {
        return !e && ("emptyString" === r && (t = "Key"), isFunction(checkLog[r]) && checkLog[r](t), "keyLength" === r) || e
      }
    },
    unbindKey: {
    ...
    bindValue: {
      rules: ["string", "emptyString", "idLength"],
      onComplete: function (e, t, r) {
        return !e && ("emptyString" === r && (t = "Value"), isFunction(checkLog[r]) && checkLog[r](t), "idLength" === r) || e
      }
    },
    check: function (e, t, r) {
      ...
      for (var n = 0; n < i.rules.length; n++) {
        var s = i.rules[n],
          a = ruleOption[s](t),
          o = isFunction(r) ? r(a, t, s) : i.onComplete(a, t, s);
        if (!a) return o
      }
      return !0
    }
...
function processAddCustomProps(e) {
  return dataStageImpl.stage.process("addCustomProps", e)
}

function processFormatData(e) {
  return dataStageImpl.stage.process("formatData", e)
}
var saEvent = {};
saEvent.check = check, saEvent.sendItem = function (e) {
  ...
  extend(t, e), dataStageImpl.stage.process("formatData", t), sd.sendState.getSendCall(t)
  ...
  var t = e;
  ajax$1({
    url: -1 !== sd.para.debug_mode_url.indexOf("?") ? sd.para.debug_mode_url + "&" + sd.kit.encodeTrackData(e) : sd.para.debug_mode_url + "?" + sd.kit.encodeTrackData(e),
    type: "GET",
    cors: !0,
    header: {
    ...
    success: function (e) {
      !0 === isEmptyObject(e) ? alert("debug\u6570\u636e\u53d1\u9001\u6210\u529f" + t) : alert("debug\u5931\u8d25 \u9519\u8bef\u539f\u56e0" + JSON.stringify(e))
    }
  })
};
var UNLIMITED_TAGS_MAP = {
  ...
  heatmap = {
    ...
    getTargetElement: function (e, t) {
      ...
      if (indexOf(a, n) > -1) return i;
      if ("area" === n && "map" === s.tagName.toLowerCase() && ry(s).prev().tagName && "img" === ry(s).prev().tagName.toLowerCase()) return ry(s).prev();
      if ("div" === n && sd.para.heatmap.collect_tags.div && r.isDivLevelValid(i) && ((sd.para.heatmap && sd.para.heatmap.collect_tags && sd.para.heatmap.collect_tags.div && sd.para.heatmap.collect_tags.div.max_level || 1) > 1 || r.isCollectableDiv(i))) return i;
    ...
    isDivLevelValid: function (e) {
      for (var t = sd.para.heatmap && sd.para.heatmap.collect_tags && sd.para.heatmap.collect_tags.div && sd.para.heatmap.collect_tags.div.max_level || 1, r = e.getElementsByTagName("div"), i = r.length - 1; i >= 0; i--)
    ...
    getElementPosition: function (e, t, r) {
      ...
      if (a > 1) {
        for (var d = 0; d < a; d++) {
          sd.heatmap.getElementPath(s[d], r) === t && o.push(s[d])
        }
      ...
      return function (e) {
        ...
        for (var t = 0, r = e; ry(r).previousElementSibling().ele; r = ry(r).previousElementSibling().ele, t++);
        return t
      }(i)
    },
    setNotice: function (e) {
      sd.is_heatmap_render_mode = !0, sd.para.heatmap || (sd.errorMsg = "\u60a8SDK\u6ca1\u6709\u914d\u7f6e\u5f00\u542f\u70b9\u51fb\u56fe\uff0c\u53ef\u80fd\u6ca1\u6709\u6570\u636e\uff01"), e && "http:" === e.slice(0, 5) && "https:" === location.protocol && (sd.errorMsg = "\u60a8\u7684\u5f53\u524d\u9875\u9762\u662fhttps\u7684\u5730\u5740\uff0c\u795e\u7b56\u5206\u6790\u73af\u5883\u4e5f\u5fc5\u987b\u662fhttps\uff01"), sd.para.heatmap_url || (sd.para.heatmap_url = getSafeHttpProtocol() + "//static.sensorsdata.cn/sdk/" + sd.lib_version + "/heatmap.min.js")
    },
    ...
    selector: function (e, t) {
      ...
      return e.getAttribute && e.getAttribute("id") && /^[A-Za-z][-A-Za-z0-9_:.]*$/.test(e.getAttribute("id")) && (!sd.para.heatmap || sd.para.heatmap && "not_use_id" !== sd.para.heatmap.element_selector) && !t ? "#" + e.getAttribute("id") : e.tagName.toLowerCase() + (~r ? ":nth-of-type(" + (r + 1) + ")" : "")
    },
    getDomSelector: function (e, t, r) {
      if (!e || !e.parentNode || !e.parentNode.children) return !1;
      t = t && t.join ? t : [];
      var i = e.nodeName.toLowerCase();
      return e && "body" !== i && 1 == e.nodeType ? (t.unshift(this.selector(e, r)), e.getAttribute && e.getAttribute("id") && /^[A-Za-z][-A-Za-z0-9_:.]*$/.test(e.getAttribute("id")) && sd.para.heatmap && "not_use_id" !== sd.para.heatmap.element_selector && !r ? t.join(" > ") : this.getDomSelector(e.parentNode, t, r)) : (t.unshift("body"), t.join(" > "))
    },
    na: function () {
    ...
    getEleDetail: function (e) {
      ...
      r.$element_selector = t || "", r.$element_path = sd.heatmap.getElementPath(e, sd.para.heatmap && "not_use_id" === sd.para.heatmap.element_selector);
      var i = sd.heatmap.getElementPosition(e, r.$element_path, sd.para.heatmap && "not_use_id" === sd.para.heatmap.element_selector);
    ...
    getPointerEventProp: function (e, t) {
      ...
      return function (e) {
        var s = e.pageX || e.clientX + r().scrollLeft || e.offsetX + i(t).targetEleX || 0,
          a = e.pageY || e.clientY + r().scrollTop || e.offsetY + i(t).targetEleY || 0;
        return {
          $page_x: n(s),
          $page_y: n(a)
        }
    ...
    start: function (e, t, r, i, n) {
      var s = isObject(i) ? i : {},
        a = isFunction(n) ? n : isFunction(i) ? i : undefined;
      ...
      o = extend(o, this.getPointerEventProp(e, t), s), "a" === r && sd.para.heatmap && !0 === sd.para.heatmap.isTrackLink ? sd.trackLink({
        event: e,
        target: t
      }, "$WebClick", o) : sd.track("$WebClick", o, a)
    },
        ...
        for (var r = 0; r < e.children.length; r++)
          if (1 === e.children[r].nodeType) {
            var i = e.children[r].tagName.toLowerCase(),
              n = sd.para && sd.para.heatmap && sd.para.heatmap.collect_tags && sd.para.heatmap.collect_tags.div && sd.para.heatmap.collect_tags.div.max_level;
    ...
    getCollectableParent: function (e, t) {
      try {
        ...
        if ("body" === i) return !1;
        var n = sd.para && sd.para.heatmap && sd.para.heatmap.collect_tags && sd.para.heatmap.collect_tags.div && sd.para.heatmap.collect_tags.div.max_level;
    ...
    initScrollmap: function () {
      ...
      var t = function (e) {
        ...
        func: function (e, t) {
          ...
          (n > sd.para.heatmap.scroll_delay_time && r - e.$viewport_position != 0 || t) && (e.$url = getURL(), e.$title = document.title, e.$url_path = getURLPath(), e.event_duration = Math.min(sd.para.heatmap.scroll_event_duration, parseInt(n) / 1e3), e.event_duration = e.event_duration < 0 ? 0 : e.event_duration, sd.track("$WebStay", e)), this.current_time = i
        }
      });
      t.current_time = new Date, addEvent$1(window, "scroll", function () {
        if (!e) return !1;
        t.go()
    ...
    initHeatmap: function () {
      ...
      isFunction(sd.para.heatmap.collect_url) && this.listenUrlChange(function () {
      ...
      }), "all" === sd.para.heatmap.collect_elements ? sd.para.heatmap.collect_elements = "all" : sd.para.heatmap.collect_elements = "interact", "all" === sd.para.heatmap.collect_elements ? addEvent$1(document, "click", function (r) {
        if (!t) return !1;
        ...
        "a" === a || "button" === a ? e.start(i, n.parentNode, a) : e.start(i, n, s)
      }) : addEvent$1(document, "click", function (r) {
        if (!t) return !1;
        var i = r || window.event;
        if (!i) return !1;
        var n = i.target || i.srcElement,
          s = sd.heatmap.getTargetElement(n, r);
        s ? e.start(i, s, s.tagName.toLowerCase()) : isElement(n) && "div" === n.tagName.toLowerCase() && isObject(sd.para.heatmap) && sd.para.heatmap.get_vtrack_config && sd.unlimitedDiv.events.length > 0 && sd.unlimitedDiv.isTargetEle(n) && e.start(i, n, n.tagName.toLowerCase(), {
          $lib_method: "vtrack"
        })
      })
    }
  ...
  commonWays = {
    setOnlineState: function (e) {
      if (!0 === e && isObject(sd.para.jsapp) && "function" == typeof sd.para.jsapp.getData) {
        sd.para.jsapp.isOnline = !0;
        var t = sd.para.jsapp.getData();
        isArray(t) && t.length > 0 && each(t, function (e) {
    ...
    setProfileLocal: function (e) {
      ...
      var t = sd.store.readObjectVal("sensorsdata_2015_jssdk_profile"),
        r = !1;
      if (isObject(t) && !isEmptyObject(t)) {
        for (var i in e) !(i in t && t[i] !== e[i]) && i in t || (t[i] = e[i], r = !0);
        r && (sd.store.saveObjectVal("sensorsdata_2015_jssdk_profile", t), sd.setProfile(e))
      } else sd.store.saveObjectVal("sensorsdata_2015_jssdk_profile", e), sd.setProfile(e)
    },
    ...
    trackHeatMap: function (e, t, r) {
      if ("object" == typeof e && e.tagName) {
        var i = e.tagName.toLowerCase(),
          ...
          s = sd.para.heatmap && sd.para.heatmap.track_attr ? sd.para.heatmap.track_attr : ["data-sensors-click"];
        "button" === i || "a" === i || "a" === n || "button" === n || "input" === i || "textarea" === i || hasAttributes(e, s) || heatmap.start(null, e, i, t, r)
      }
    },
    ...
    autoTrackSinglePage: function (e, t) {
      ...
      var n = !(e = isObject(e) ? e : {}).not_set_profile;
      ...
      if (e.not_set_profile && delete e.not_set_profile, s(e, t), this.autoTrackSinglePage = s, sd.is_first_visitor && n) {
        var a = {};
        sd.para.preset_properties.search_keyword_baidu && isReferralTraffic(document.referrer) && isBaiduTraffic() && (a.$search_keyword_id = getBaiduKeyword.id(), a.$search_keyword_id_type = getBaiduKeyword.type(), a.$search_keyword_id_hash = hashCode53(a.$search_keyword_id)), sd.setOnceProfile(extend({
    ...
    autoTrack: function (e, t) {
      ...
      each(r, function (e, t, r) {
        -1 !== (" " + sd.source_channel_standard + " ").indexOf(" " + t + " ") ? i["$" + t] = r[t] : i[t] = r[t]
      });
      var n = !e.not_set_profile;
      e.not_set_profile && delete e.not_set_profile;
      var s = location.href;
      if (sd.para.is_single_page && addHashEvent(function () {
          var r = getReferrer(s, !0);
          sd.track("$pageview", extend({
            $referrer: r,
            $url: getURL(),
            $url_path: getURLPath(),
    ...
    getAnonymousID: function () {
      return isEmptyObject(sd.store._state) ? "\u8bf7\u5148\u521d\u59cb\u5316SDK" : sd.store._state._first_id || sd.store._state.first_id || sd.store._state._distinct_id || sd.store._state.distinct_id
    },
    setPlugin: function (e) {
      if (!isObject(e)) return !1;
      each(e, function (e, t) {
        isFunction(e) && (isObject(window.SensorsDataWebJSSDKPlugin) && window.SensorsDataWebJSSDKPlugin[t] ? e(window.SensorsDataWebJSSDKPlugin[t]) : sd.log(t + "\u6ca1\u6709\u83b7\u53d6\u5230,\u8bf7\u67e5\u9605\u6587\u6863\uff0c\u8c03\u6574" + t + "\u7684\u5f15\u5165\u987a\u5e8f\uff01"))
      })
    },
...
function addSinglePageEvent(e) {
  ...
  }), t = window.document.documentMode ? "hashchange" : i ? "popstate" : "hashchange", addEvent(window, t, function () {
    e(r), r = location.href
  })
}
...
function addPropsHook(e) {
  var t = !e.type || "profile" !== e.type.slice(0, 7),
    r = sd.para.preset_properties && t;
  r && sd.para.preset_properties.url && "undefined" == typeof e.properties.$url && (e.properties.$url = getURL()), r && sd.para.preset_properties.title && "undefined" == typeof e.properties.$title && (e.properties.$title = document.title)
}
...
function initPara(e) {
  ...
  for (t in sd.para.preset_properties = extend({}, sd.para_default.preset_properties, r, sd.para.preset_properties || {}), sd.para_default) void 0 === sd.para[t] && (sd.para[t] = sd.para_default[t]);
  "string" == typeof sd.para.server_url && (sd.para.server_url = trim(sd.para.server_url), sd.para.server_url && ("://" === sd.para.server_url.slice(0, 3) ? sd.para.server_url = location.protocol.slice(0, -1) + sd.para.server_url : "//" === sd.para.server_url.slice(0, 2) ? sd.para.server_url = location.protocol + sd.para.server_url : "http" !== sd.para.server_url.slice(0, 4) && (sd.para.server_url = ""))), "string" != typeof sd.para.web_url || "://" !== sd.para.web_url.slice(0, 3) && "//" !== sd.para.web_url.slice(0, 2) || ("://" === sd.para.web_url.slice(0, 3) ? sd.para.web_url = location.protocol.slice(0, -1) + sd.para.web_url : sd.para.web_url = location.protocol + sd.para.web_url), "image" !== sd.para.send_type && "ajax" !== sd.para.send_type && "beacon" !== sd.para.send_type && (sd.para.send_type = "image"), sd.debug.protocol.serverUrl(), sd.bridge.initPara();
  var n = {
    datasend_timeout: 6e3,
    send_interval: 6e3
  };
  _localStorage.isSupport() && isSupportCors() && "object" == typeof localStorage ? !0 === sd.para.batch_send ? sd.para.batch_send = extend({}, n) : "object" == typeof sd.para.batch_send && (sd.para.batch_send = extend({}, n, sd.para.batch_send)) : sd.para.batch_send = !1;
  ...
  "object" == typeof sd.para.source_type && (sd.para.source_type.utm = isArray(sd.para.source_type.utm) ? sd.para.source_type.utm.concat(s) : s, sd.para.source_type.search = isArray(sd.para.source_type.search) ? sd.para.source_type.search.concat(a) : a, sd.para.source_type.social = isArray(sd.para.source_type.social) ? sd.para.source_type.social.concat(o) : o, sd.para.source_type.keyword = isObject(sd.para.source_type.keyword) ? extend(d, sd.para.source_type.keyword) : d);
  ...
  if (sd.para.heatmap && !isObject(sd.para.heatmap) && (sd.para.heatmap = {}), isObject(sd.para.heatmap)) {
    ...
    var l = isArray(sd.para.heatmap.track_attr) ? filter(sd.para.heatmap.track_attr, function (e) {
      return e && "string" == typeof e
    }) : [];
    if (l.push("data-sensors-click"), sd.para.heatmap.track_attr = l, isObject(sd.para.heatmap.collect_tags))
      if (!0 === sd.para.heatmap.collect_tags.div) sd.para.heatmap.collect_tags.div = {
        ignore_tags: c,
        max_level: 1
      };
      else if (isObject(sd.para.heatmap.collect_tags.div)) {
      if (sd.para.heatmap.collect_tags.div.ignore_tags ? isArray(sd.para.heatmap.collect_tags.div.ignore_tags) || (sd.log("ignore_tags \u53c2\u6570\u5fc5\u987b\u662f\u6570\u7ec4\u683c\u5f0f"), sd.para.heatmap.collect_tags.div.ignore_tags = c) : sd.para.heatmap.collect_tags.div.ignore_tags = c, sd.para.heatmap.collect_tags.div.max_level) {
        -1 === indexOf([1, 2, 3], sd.para.heatmap.collect_tags.div.max_level) && (sd.para.heatmap.collect_tags.div.max_level = 1)
      }
  ...
  "string" == typeof sd.para.server_url && (sd.para.debug_mode_url = sd.para.debug_mode_url || sd.para.server_url.replace("sa.gif", "debug")), !0 === sd.para.noCache ? sd.para.noCache = "?" + (new Date).getTime() : sd.para.noCache = "", sd.para.callback_timeout > sd.para.datasend_timeout && (sd.para.datasend_timeout = sd.para.callback_timeout), sd.para.heatmap && sd.para.heatmap.collect_tags && isObject(sd.para.heatmap.collect_tags) && each(sd.para.heatmap.collect_tags, function (e, t) {
...
function resetIdentities(e) {
  ...
  sd.store._state.identities = t, sd.store.save()
}

function setInitVar() {
  sd._t = sd._t || 1 * new Date, sd.lib_version = sdkversion_placeholder, sd.is_first_visitor = !1, sd.source_channel_standard = source_channel_standard
}
...
function use(e, t) {
  return isString(e) ? isObject(window.SensorsDataWebJSSDKPlugin) && isObject(window.SensorsDataWebJSSDKPlugin[e]) && isFunction(window.SensorsDataWebJSSDKPlugin[e].init) ? (window.SensorsDataWebJSSDKPlugin[e].init(sd, t), window.SensorsDataWebJSSDKPlugin[e]) : isObject(sd.modules) && isObject(sd.modules[e]) && isFunction(sd.modules[e].init) ? (sd.modules[e].init(sd, t), sd.modules[e]) : void sd.log(e + "\u6ca1\u6709\u83b7\u53d6\u5230,\u8bf7\u67e5\u9605\u6587\u6863\uff0c\u8c03\u6574" + e + "\u7684\u5f15\u5165\u987a\u5e8f\uff01") : (sd.log("use\u63d2\u4ef6\u540d\u79f0\u5fc5\u987b\u662f\u5b57\u7b26\u4e32\uff01"), !1)
}
...
function bind(e, t) {
  ...
  sd.store._state.identities[e] = t, sd.store.save(), saEvent.send({
    type: "track_id_bind",
    event: "$BindID",
    properties: {}
  })
...
function unbind(e, t) {
  ...
  if (isObject(sd.store._state.identities) && sd.store._state.identities.hasOwnProperty(e) && sd.store._state.identities[e] === t) {
    var r = sd.store.getUnionId().login_id;
    r && e + "+" + t === r && (sd.store._state.distinct_id = sd.store._state.first_id, sd.store._state.first_id = "", sd.store.set("history_login_id", {
      name: "",
      value: ""
    })), "$identity_cookie_id" !== e && (delete sd.store._state.identities[e], sd.store.save())
  }
  var i = {};
  i[e] = t, saEvent.send({
    identities: i,
...
function trackLink(e, t, r) {
  function i(e, t, r) {
    var i = null;
    if ((e = e || {}).ele && (i = e.ele), e.event && (i = e.target ? e.target : e.event.target), r = r || {}, !i || "object" != typeof i) return !1;
    if (!i.href || /^javascript/.test(i.href) || i.target || i.download || i.onclick) return sd.track(t, r), !1;
    ...
    e.event && n(e.event), e.ele && addEvent$1(e.ele, "click", function (e) {
      n(e)
    })
  }
...
function trackLinks(e, t, r) {
  return r = r || {}, !(!e || "object" != typeof e) && (!(!e.href || /^javascript/.test(e.href) || e.target) && void addEvent$1(e, "click", function (i) {
    i.preventDefault();
    var n = !1;
...
function appendProfile(e, t) {
  saEvent.check({
    ...
    isString(t) ? e[r] = [t] : isArray(t) ? e[r] = t : (delete e[r], sd.log("appendProfile\u5c5e\u6027\u7684\u503c\u5fc5\u987b\u662f\u5b57\u7b26\u4e32\u6216\u8005\u6570\u7ec4"))
...
function incrementProfile(e, t) {
  var r = e;
  isString(e) && ((e = {})[r] = 1), saEvent.check({
    propertiesMust: e
  }) && (! function (e) {
    for (var t in e)
...
function unsetProfile(e, t) {
  ...
  isString(e) && (e = []).push(r), isArray(e) ? (each(e, function (e) {
    isString(e) ? i[e] = !0 : sd.log("profile_unset\u7ed9\u7684\u6570\u7ec4\u91cc\u9762\u7684\u503c\u5fc5\u987b\u65f6string,\u5df2\u7ecf\u8fc7\u6ee4\u6389", e)
  }), saEvent.send({
    type: "profile_unset",
    properties: i
...
function identify(e, t) {
  function r(e) {
    sd.store._state.identities.$identity_anonymous_id = e, sd.store.save()
  }
  "number" == typeof e && (e = String(e));
  var i = store.getFirstId();
  if (void 0 === e) {
    var n = UUID();
    i ? store.set("first_id", n) : store.set("distinct_id", n), r(n)
  } else saEvent.check({
    distinct_id: e
  }) && (!0 === t ? i ? store.set("first_id", e) : store.set("distinct_id", e) : i ? store.change("first_id", e) : store.change("distinct_id", e), r(e))
}
...
function trackSignup(e, t, r, i) {
  "number" == typeof e && (e = String(e)), saEvent.check({
    distinct_id: e,
    event: t,
    properties: r
  }) && sendSignup(e, t, r, i)
...
function clearPageRegister(e) {
  ...
  if (isArray(e) && e.length > 0)
    for (t = 0; t < e.length; t++) isString(e[t]) && e[t] in pageInfo.currentProps && delete pageInfo.currentProps[e[t]];
  else if (!0 === e)
...
function loginBody(e) {
  ...
  if (!saEvent.check({
      distinct_id: t
    })) return sd.log("login id is invalid"), !1;
  if (t === sd.store.getOriginDistinctId() && !n) return sd.log("login id is equal to distinct_id"), !1;
  if (isObject(sd.store._state.identities) && sd.store._state.identities.hasOwnProperty(i) && t === sd.store._state.first_id) return !1;
  if (sd.store._state.history_login_id.name !== i || t !== sd.store._state.history_login_id.value) {
    sd.store._state.identities[i] = t, sd.store.set("history_login_id", {
      name: i,
      value: t
    }), n || store.set("first_id", s), sendSignup(t, "$SignUp", {}, r);
    var a = {
      $identity_cookie_id: sd.store._state.identities.$identity_cookie_id
    };
    return a[i] = t, resetIdentities(a), !0
  }
  return !1
}
...
function loginWithKey(e, t) {
  return "number" == typeof t && (t = String(t)), "number" == typeof e && (e = String(e)), !!saEvent.check({
    loginIdKey: e
...
function getPresetProperties() {
  var e, t, r = {
    ...
    i = extend({}, pageInfo.properties(), sd.store.getProps(), (e = pageInfo.campaignParams(), t = {}, each(e, function (e, r, i) {
      -1 !== (" " + sd.source_channel_standard + " ").indexOf(" " + r + " ") ? t["$" + r] = i[r] : t[r] = i[r]
    }), t), r);
  return sd.para.preset_properties.latest_referrer && sd.para.preset_properties.latest_referrer_host && (i.$latest_referrer_host = "" === i.$latest_referrer ? "" : getHostname(i.$latest_referrer)), i
}
...
function iOSWebClickPolyfill() {
  ...
  sd.heatmap && isArray(sd.heatmap.otherTags) && each(sd.heatmap.otherTags, function (r) {
    e += r + t
  }), isIOS() && getIOSVersion() && getIOSVersion() < 13 && (sd.para.heatmap && sd.para.heatmap.collect_tags && sd.para.heatmap.collect_tags.div && setCssStyle("div, [data-sensors-click]" + t), sd.para.heatmap && sd.para.heatmap.track_attr && setCssStyle("[" + sd.para.heatmap.track_attr.join("], [") + "]" + t), "" !== e && setCssStyle(e))
}
var functions = {
    __proto__: null,
...
var ImageSender = function (e) {
  this.callback = e.callback, this.img = document.createElement("img"), this.img.width = 1, this.img.height = 1, sd.para.img_use_crossorigin && (this.img.crossOrigin = "anonymous"), this.data = e.data, this.server_url = getSendUrl(e.server_url, e.data)
};
ImageSender.prototype.start = function () {
  ...
  getUA().ie !== undefined ? this.img.src = "about:blank" : this.img.src = ""
};
var AjaxSender = function (e) {
  this.callback = e.callback, this.server_url = e.server_url, this.data = getSendData(e.data)
};
...
function getSendType(e) {
  var t = ["image", "ajax", "beacon"],
    r = t[0];
  return "beacon" === (r = e.config && indexOf(t, e.config.send_type) > -1 ? e.config.send_type : sd.para.send_type) && !1 === isSupportBeaconSend() && (r = "image"), "ajax" === r && !1 === isSupportCors() && (r = "image"), r
}
...
var sendStageImpl = {
  ...
  sendState = {
    getSendCall: function (e, t, r) {
      ...
      e._track_id = Number(String(getRandom()).slice(2, 5) + String(getRandom()).slice(2, 4) + String((new Date).getTime()).slice(-4)), e._flush_time = (new Date).getTime();
      var i = e;
      e = JSON.stringify(e);
      var n = {
        data: i,
      ...
      if (sd.events.tempAdd("send", i), !sd.para.app_js_bridge && sd.para.batch_send && _localStorage.isSupport() && localStorage.length < 100) return sd.log(i), sd.batchSend.add(n.data), !1;
      "item_set" === i.type || "item_delete" === i.type ? this.prepareServerUrl(n) : sendStageImpl.stage.process("beforeSend", n), sd.log(i)
    },
    prepareServerUrl: function (e) {
      if ("object" == typeof e.config && e.config.server_url) this.sendCall(e, e.config.server_url, e.callback);
        ...
        for (var t = 0; t < sd.para.server_url.length; t++) this.sendCall(e, sd.para.server_url[t]);
      else "string" == typeof sd.para.server_url && "" !== sd.para.server_url ? this.sendCall(e, sd.para.server_url, e.callback) : sd.log("\u5f53\u524d server_url \u4e3a\u7a7a\u6216\u4e0d\u6b63\u786e\uff0c\u53ea\u5728\u63a7\u5236\u53f0\u6253\u5370\u65e5\u5fd7\uff0cnetwork \u4e2d\u4e0d\u4f1a\u53d1\u6570\u636e\uff0c\u8bf7\u914d\u7f6e\u6b63\u786e\u7684 server_url\uff01")
    },
    sendCall: function (e, t, r) {
      ...
      isObject(sd.para.jsapp) && !sd.para.jsapp.isOnline && "function" == typeof sd.para.jsapp.setData ? (delete i.callback, i = JSON.stringify(i), sd.para.jsapp.setData(i)) : this.realtimeSend(i)
    },
    realtimeSend: function (e) {
      getRealtimeInstance(e).start()
    }
  },
  dataStoragePrefix = "sawebjssdk-",
...
BatchSend.prototype = {
  ...
  getServerUrl: function () {
    if (!(isString(sd.para.server_url) && "" !== sd.para.server_url || isArray(sd.para.server_url) && sd.para.server_url.length)) return sd.log("\u5f53\u524d server_url \u4e3a\u7a7a\u6216\u4e0d\u6b63\u786e\uff0c\u53ea\u5728\u63a7\u5236\u53f0\u6253\u5370\u65e5\u5fd7\uff0cnetwork \u4e2d\u4e0d\u4f1a\u53d1\u6570\u636e\uff0c\u8bf7\u914d\u7f6e\u6b63\u786e\u7684 server_url\uff01");
    this.serverUrl = isArray(sd.para.server_url) ? sd.para.server_url[0] : sd.para.server_url
  },
  send: function () {
    if (!(this.sendTimeStamp && now() - this.sendTimeStamp < sd.para.batch_send.datasend_timeout)) {
      var e = _localStorage.get(this.tabKey);
      if (e && (this.sendTimeStamp = now(), (e = safeJSONParse(e) || this.generateTabStorageVal()).data.length)) {
        for (var t = [], r = 0; r < e.data.length; r++) t.push(sd.store.readObjectVal(e.data[r]));
  ...
  updateExpireTime: function () {
    var e = _localStorage.get(this.tabKey);
    e && ((e = safeJSONParse(e) || this.generateTabStorageVal()).expireTime = now() + 2 * sd.para.batch_send.send_interval, e.serverUrl = this.serverUrl, _localStorage.set(this.tabKey, JSON.stringify(e)))
  },
  ...
  recycle: function () {
    for (var e = {}, t = 0; t < localStorage.length; t++) {
      ...
      if (0 === r.indexOf(tabStoragePrefix)) {
        for (var n = safeJSONParse(_localStorage.get(r)) || this.generateTabStorageVal(), s = 0; s < n.data.length; s++) e[n.data[s]] = !0;
        if (now() > n.expireTime && this.serverUrl === n.serverUrl) new ConcurrentStorage("sajssdk-lock-get-").get(r, 1e4, 1e3, function (e) {
          if (e) {
            null === _localStorage.get(i.tabKey) && i.generateTabStorage();
            var t = safeJSONParse(e) || i.generateTabStorageVal();
            _localStorage.set(i.tabKey, JSON.stringify(i.generateTabStorageVal((safeJSONParse(_localStorage.get(i.tabKey)) || this.generateTabStorageVal()).data.concat(t.data))))
          }
        })
      } else if (0 === r.indexOf("sajssdk-lock-get-")) {
        var a = safeJSONParse(_localStorage.get(r)) || {
          expireTime: 0
        };
        now() - a.expireTime > 1e4 && _localStorage.remove(r)
      }
    }
...
var batchSend = new BatchSend,
  bridge = {
    ...
    initPara: function () {
      ...
      "object" == typeof sd.para.app_js_bridge ? sd.para.app_js_bridge = extend({}, e, sd.para.app_js_bridge) : !0 !== sd.para.use_app_track && !0 !== sd.para.app_js_bridge && "only" !== sd.para.use_app_track && "mui" !== sd.para.use_app_track || (sd.para.app_js_bridge = extend({}, e)), !1 === sd.para.app_js_bridge.is_send && sd.log("\u8bbe\u7f6e\u4e86 is_send:false,\u5982\u679c\u6253\u901a\u5931\u8d25\uff0c\u6570\u636e\u5c06\u88ab\u4e22\u5f03!")
    },
    app_js_bridge_v1: function () {
      ...
      window.sensorsdata_app_js_bridge_call_js = function (r) {
        ...
        if (function () {
          ...
          }(), "object" == typeof window.SensorsData_APP_JS_Bridge && window.SensorsData_APP_JS_Bridge.sensorsdata_call_app && isJSONString(e = SensorsData_APP_JS_Bridge.sensorsdata_call_app()) && (e = JSON.parse(e)), !r) return e;
  ...
  this.type = e, this.resultCbs = {}, this.timeoutCbs = {}, this.timerId = null, this.appCallJsCallback = null, window.sensorsdata_app_call_js || (window.sensorsdata_app_call_js = function (e, t) {
    ...
    try {
      ...
      if (i && t.resultCbs[i]) {
        ...
        if (t.resultCbs[i])
          for (var n in t.resultCbs[i].result = e, clearTimeout(t.timerId), t.timeoutCbs[i].callbacks.length = 0, t.resultCbs[i].callbacks) t.resultCbs[i].callbacks[n].call(null, e), t.resultCbs[i].callbacks.splice(n, 1);
        return
      }
...
function handleCommands(e) {
  try {
    if (sd.bridge.activeBridge && isFunction(sd.bridge.activeBridge.handleCommand)) return sd.bridge.activeBridge.handleCommand(e)
  } catch (t) {
    sd.log("Error: handle command exception:" + t)
  }
  return sd.log("\u6570\u636e\u53d1\u5f80App\u5931\u8d25\uff0cApp\u6ca1\u6709\u66b4\u9732bridge,type:" + e.callType), !1
}
...
function validateAppUrl(e) {
  ...
  if (isArray(sd.para.app_js_bridge.white_list))
    for (var n = 0; n < sd.para.app_js_bridge.white_list.length; n++) {
      var s = t(sd.para.app_js_bridge.white_list[n]);
...
SDKJSBridge.prototype.call = function (e, t) {
  ...
  return t && (this.timerId = setTimeout(function () {
    for (var e in r.timeoutCbs[i].isTimeout = !0, r.timeoutCbs[i].callbacks) r.timeoutCbs[i].callbacks[e].call(null), r.timeoutCbs[i].callbacks.splice(e, 1)
  }, t)), handleCommands(n), {
    onResult: function (e) {
...
var vtrackBase = {
    initUrl: function () {
      ...
      if (!isString(sd.para.server_url)) return sd.log("----vcollect---server_url\u5fc5\u987b\u4e3a\u5b57\u7b26\u4e32"), !1;
      try {
        e = _URL(sd.para.server_url), r.server_url.project = e.searchParams.get("project") || "default", r.server_url.host = e.host
      } catch (i) {
    ...
    configIsMatch: function (e, t) {
      return (!t.limit_element_content || t.element_content === e.$element_content) && ((!t.limit_element_position || t.element_position === String(e.$element_position)) && (t.element_field && t["function"] ? vtrackBase.configIsMatchNew(e, t) : vtrackBase.configIsMatchOldVersion(e, t)))
    },
    ...
    filterConfig: function (e, t, r) {
      ...
      return "$WebClick" === e.event && each(t, function (t) {
        isObject(t) && ("webclick" === t.event_type || "appclick" === t.event_type) && isObject(t.event) && t.event.url_host === r.host && t.event.url_path === r.pathname && vtrackBase.configIsMatch(e.properties, t.event) && i.push(t)
      }), i
    },
    getPropElInLi: function (e, t) {
      ...
      return sd.log("----custom---\u83b7\u53d6\u540c\u7ea7\u5c5e\u6027\u5143\u7d20\u5931\u8d25\uff0cselector\u4fe1\u606f\u5f02\u5e38", r, t), null
    },
    getProp: function (e, t) {
      if (!isObject(e)) return !1;
      if (!(isString(e.name) && e.name.length > 0)) return sd.log("----vcustom----\u5c5e\u6027\u540d\u4e0d\u5408\u6cd5,\u5c5e\u6027\u629b\u5f03", e.name), !1;
      var r, i, n = {};
      if ("content" === e.method) {
        var s;
        if (isString(e.element_selector) && e.element_selector.length > 0) s = getDomBySelector(e.element_selector);
        else {
          if (!t || !isString(e.list_selector)) return sd.log("----vcustom----\u5c5e\u6027\u914d\u7f6e\u5f02\u5e38\uff0c\u5c5e\u6027\u629b\u5f03", e.name), !1;
          var a = getDomBySelector(t.properties.$element_selector);
          if (!a) return sd.log("----vcustom----\u70b9\u51fb\u5143\u7d20\u83b7\u53d6\u5f02\u5e38\uff0c\u5c5e\u6027\u629b\u5f03", e.name), !1;
          var o = sd.heatmap.getClosestLi(a);
          s = vtrackBase.getPropElInLi(o, e.list_selector)
        }
        if (!s || !isElement(s)) return sd.log("----vcustom----\u5c5e\u6027\u5143\u7d20\u83b7\u53d6\u5931\u8d25\uff0c\u5c5e\u6027\u629b\u5f03", e.name), !1;
        if ("input" === s.tagName.toLowerCase()) r = s.value || "";
        else if ("select" === s.tagName.toLowerCase()) {
          var d = s.selectedIndex;
          isNumber(d) && isElement(s[d]) && (r = getElementContent$1(s[d], "select"))
        } else r = getElementContent$1(s, s.tagName.toLowerCase());
        if (e.regular) {
          try {
            i = new RegExp(e.regular).exec(r)
          } catch (c) {
            return sd.log("----vcustom----\u6b63\u5219\u5904\u7406\u5931\u8d25\uff0c\u5c5e\u6027\u629b\u5f03", e.name), !1
          }
          if (null === i) return sd.log("----vcustom----\u5c5e\u6027\u89c4\u5219\u5904\u7406\uff0c\u672a\u5339\u914d\u5230\u7ed3\u679c,\u5c5e\u6027\u629b\u5f03", e.name), !1;
          if (!isArray(i) || !isString(i[0])) return sd.log("----vcustom----\u6b63\u5219\u5904\u7406\u5f02\u5e38\uff0c\u5c5e\u6027\u629b\u5f03", e.name, i), !1;
          r = i[0]
        }
        if ("STRING" === e.type) n[e.name] = r;
        else if ("NUMBER" === e.type) {
          if (r.length < 1) return sd.log("----vcustom----\u672a\u83b7\u53d6\u5230\u6570\u5b57\u5185\u5bb9\uff0c\u5c5e\u6027\u629b\u5f03", e.name, r), !1;
          if (isNaN(Number(r))) return sd.log("----vcustom----\u6570\u5b57\u7c7b\u578b\u5c5e\u6027\u8f6c\u6362\u5931\u8d25\uff0c\u5c5e\u6027\u629b\u5f03", e.name, r), !1;
          n[e.name] = Number(r)
        }
        return n
      }
      return sd.log("----vcustom----\u5c5e\u6027\u4e0d\u652f\u6301\u6b64\u83b7\u53d6\u65b9\u5f0f", e.name, e.method), !1
    },
    getAssignConfigs: function (e, t) {
      ...
      var i = [];
      return t.events = t.events || t.eventList, isArray(t.events) && t.events.length > 0 ? (each(t.events, function (t) {
        isObject(t) && isObject(t.event) && t.event.url_host === r.page_url.host && t.event.url_path === r.page_url.pathname && e(t) && i.push(t)
      }), i) : []
    },
    addCustomProps: function (e) {
      if ("success" === sd.bridge.bridge_info.verify_success) {
        var t = sd.vapph5collect.customProp.geth5Props(JSON.parse(JSON.stringify(e)));
        isObject(t) && !isEmptyObject(t) && (e.properties = extend(e.properties, t))
      }
      var r = sd.vtrackcollect.customProp.getVtrackProps(JSON.parse(JSON.stringify(e)));
      return isObject(r) && !isEmptyObject(r) && (e.properties = extend(e.properties, r)), e
    },
    init: function () {
      sd.vtrackcollect.init(), "success" === sd.bridge.bridge_info.verify_success && sd.vapph5collect.init()
    }
  },
  unlimitedDiv = {
    events: [],
    ...
    isTargetEle: function (e) {
      ...
      for (var r = 0; r < this.events.length; r++)
        if (isObject(this.events[r]) && isObject(this.events[r].event) && sd.vtrackcollect.configIsMatch(t, this.events[r].event)) return !0;
      return !1
    }
  },
  customProp = {
  ...
  vtrackcollect = {
    ...
    initUrl: function () {
      ...
      if (e) {
        var t;
        try {
          (t = new urlParse(sd.para.server_url))._values.Path = "/config/visualized/Web.conf", e.api_url = t.getUrl()
        } catch (r) {
    ...
    init: function () {
      ...
      if (_localStorage.isSupport() || (this.storageEnable = !1), !this.initUrl()) return sd.log("----vtrackcustom----\u521d\u59cb\u5316\u5931\u8d25\uff0curl\u4fe1\u606f\u89e3\u6790\u5931\u8d25"), !1;
      if (this.storageEnable) {
        var e = sd.store.readObjectVal(this.storage_name);
    ...
    serverUrlIsSame: function (e) {
      return !!isObject(e) && (e.host === this.url_info.server_url.host && e.project === this.url_info.server_url.project)
    },
    getConfigFromServer: function () {
      ...
      this.sendRequest(function (t, r) {
        ...
        var i = {};
        200 === t ? r && isObject(r) && "Web" === r.os && (i = r, e.updateConfig(i)) : 205 === t ? e.updateConfig(i) : 304 === t ? i = e.config : (sd.log("----vtrackcustom----\u6570\u636e\u5f02\u5e38", t), e.updateConfig(i)), e.updateStorage(i), e.setNextFetch()
      }, function (t) {
        e.update_time = (new Date).getTime(), sd.log("----vtrackcustom----\u914d\u7f6e\u62c9\u53d6\u5931\u8d25", t), e.setNextFetch()
      })
    },
    ...
    updateStorage: function (e) {
      ...
      sd.store.saveObjectVal(this.storage_name, i)
    },
  ...
  vapph5CustomProp = {
    ...
    geth5Props: function (e) {
      ...
      if ("$WebClick" === e.event) {
        ...
        if (!n.length) return {};
        each(n, function (n) {
          isObject(n) && (isArray(n.properties) && n.properties.length > 0 && each(n.properties, function (r) {
            if (isObject(r))
              if (!1 === r.h5) isArray(t.sensorsdata_app_visual_properties) || (t.sensorsdata_app_visual_properties = []), t.sensorsdata_app_visual_properties.push(r);
              else {
                var n = i.getProp(r, e);
      ...
      return t.sensorsdata_app_visual_properties && (t.sensorsdata_app_visual_properties = base64Encode(JSON.stringify(t.sensorsdata_app_visual_properties))), t
    },
      ...
      return t.onAppNotify(function (r) {
        ...
        if (isObject(r)) {
          var n = r.sensorsdata_js_visual_properties,
            s = e.initUrl();
          s && (s = s.page_url, isArray(n) && n.length > 0 && each(n, function (t) {
            if (isObject(t) && t.url_host === s.host && t.url_path === s.pathname && t.h5) {
              var r = e.getProp(t);
...
var heatmapMode = {
    isSeachHasKeyword: function () {
      return "" !== getQueryParam(location.href, "sa-request-id") && ("string" == typeof sessionStorage.getItem("sensors-visual-mode") && sessionStorage.removeItem("sensors-visual-mode"), !0)
    },
    ...
    storageHasKeywordHandle: function () {
      heatmap.setNotice(), heatmapMode.isReady(sessionStorage.getItem("sensors_heatmap_id"), sessionStorage.getItem("sensors_heatmap_type"), location.href)
    },
    ...
    windowNameHasKeywordHandle: function () {
      ...
      var r = t("sa-request-id"),
        i = t("sa-request-type"),
        n = t("sa-request-url");
      heatmap.setNotice(n), _sessionStorage.isSupport() && (null !== n && sessionStorage.setItem("sensors_heatmap_url", n), sessionStorage.setItem("sensors_heatmap_id", r), null !== i ? "1" === i || "2" === i || "3" === i ? sessionStorage.setItem("sensors_heatmap_type", i) : i = null : i = null !== sessionStorage.getItem("sensors_heatmap_type") ? sessionStorage.getItem("sensors_heatmap_type") : null), heatmapMode.isReady(r, i)
    }
  },
  vtrackMode = {
    isStorageHasKeyword: function () {
    ...
    isSearchHasKeyword: function () {
      return (!0 === getFlagValue("sa-visual-mode") || "true" === getFlagValue("sa-visual-mode")) && ("string" == typeof sessionStorage.getItem("sensors_heatmap_id") && sessionStorage.removeItem("sensors_heatmap_id"), !0)
    },
    loadVtrack: function () {
      loadScript({
        success: function () {},
    ...
    messageListener: function (e) {
      ...
      if ("v-track-mode" === e.data.type) {
        if (e.data.data && e.data.data.isVtrack)
          if (_sessionStorage.isSupport() && sessionStorage.setItem("sensors-visual-mode", "true"), e.data.data.userURL && location.href.match(/sa-visual-mode=true/)) {
            var t = isHttpUrl(r = e.data.data.userURL) ? removeScriptProtocol(r) : (sd.log("\u53ef\u89c6\u5316\u6a21\u5f0f\u68c0\u6d4b URL \u5931\u8d25"), !1);
    ...
    verifyVtrackMode: function () {
      window.addEventListener && window.addEventListener("message", vtrackMode.messageListener, !1), vtrackMode.postMessage()
    },
...
function defineMode(e) {
  ...
  function r() {
    var e = [];
    t.touch_app_bridge || e.push(sd.debug.defineMode("1")), isObject(sd.para.app_js_bridge) || (e.push(sd.debug.defineMode("2")), t.verify_success = !1), isObject(sd.para.heatmap) && "default" == sd.para.heatmap.clickmap || e.push(sd.debug.defineMode("3")), "fail" === t.verify_success && e.push(sd.debug.defineMode("4")), new sd.SDKJSBridge("app_alert").notifyApp({
      data: e
    })
  }
      ...
      if (isObject(sd.para.app_js_bridge) && "success" === t.verify_success)
        if (e) sa_jssdk_app_define_mode(sd, e);
          ...
          loadScript({
            ...
            error: function () {},
            type: "js",
            url: (i = indexOf(["http:", "https:"], i) > -1 ? i : "https:") + "//static.sensorsdata.cn/sdk/" + sd.lib_version + "/vapph5define.min.js"
          })
        }
  else r();
  else r()
...
function listenSinglePage() {
  sd.para.is_track_single_page && spa.on("switch", function (e) {
    var t = function (t) {
      t = t || {}, e !== location.href && (pageInfo.pageProp.referrer = getURL(e), sd.quick("autoTrack", extend({
        $url: getURL(),
        $referrer: getURL(e)
      }, t)))
    };
...
function trackMode() {
  ...
  }), defineMode(!1), sd.bridge.app_js_bridge_v1(), pageInfo.initPage(), listenSinglePage(), !sd.para.app_js_bridge && sd.para.batch_send && _localStorage.isSupport() && sd.batchSend.batchInterval(), sd.store.init(), sd.vtrackBase.init(), sd.readyState.setState(4), enterFullTrack()
}
...
function checkState() {
  each(methods, function (e) {
    var t = sd[e];
    sd[e] = function () {
      if (sd.readyState.state < 3) return isArray(sd._q) || (sd._q = []), sd._q.push([e, arguments]), !1;
  ...
  if (e && e in this.processDef) {
    ...
    if (r && isArray(r) && r.length > 0)
      for (var i = {
          current: 0,
          total: r.length
        }, n = new InterceptorContext(t, i, sd), s = 0; s < r.length; s++) try {
        if (i.current = s + 1, t = r[s].call(null, t, n) || t, n.cancellationToken.getCanceled()) break
      } catch (a) {
        sdLog("interceptor error:" + a)
      }
  ...
  if (e)
    for (var t in e) {
      ...
      if (r && isObject(r) && isFunction(r.entry)) {
        isNumber(r.priority) || (r.priority = Number.MAX_VALUE), this.registeredInterceptors[t] || (this.registeredInterceptors[t] = []);
...
var processDef = {
  ...
  dataStage = new Stage(processDef),
  processDef$1 = {
    beforeSend: "send",
    send: "afterSend",
    afterSend: null
  },
  sendStage = new Stage(processDef$1),
  processDef$2 = {
    getUtmData: null
  },
...
function registerFeature(e) {
  e && e.dataStage && dataStage.registerStageImplementation(e.dataStage), e && e.businessStage && businessStage.registerStageImplementation(e.businessStage), e && e.sendStage && sendStage.registerStageImplementation(e.sendStage)
}
var interceptorRegisters = {
  dataStage: function (e) {
    e && dataStage.registerInterceptor(e)
  },
  businessStage: function (e) {
    e && businessStage.registerInterceptor(e)
  },
  sendStage: function (e) {
    e && sendStage.registerInterceptor(e)
  }
};
...
function CoreFeature(e) {
  e.kit = kit, e.saEvent = saEvent, this.dataStage = dataStageImpl, this.sendStage = sendStageImpl, this.businessStage = businessStageImpl
}

function strip_sa_properties(e) {
  return isObject(e) ? (each(e, function (t, r) {
    if (isArray(t)) {
      var i = [];
      each(t, function (e) {
        isString(e) ? i.push(e) : sdLog("\u60a8\u7684\u6570\u636e-", r, t, "\u7684\u6570\u7ec4\u91cc\u7684\u503c\u5fc5\u987b\u662f\u5b57\u7b26\u4e32,\u5df2\u7ecf\u5c06\u5176\u5220\u9664")
      }), e[r] = i
    }
    isString(t) || isNumber(t) || isDate(t) || isBoolean(t) || isArray(t) || isFunction(t) || "$option" === r || (sdLog("\u60a8\u7684\u6570\u636e-", r, t, "-\u683c\u5f0f\u4e0d\u6ee1\u8db3\u8981\u6c42\uff0c\u6211\u4eec\u5df2\u7ecf\u5c06\u5176\u5220\u9664"), delete e[r])
  }), e) : e
}

function formatString(e, t) {
  return isNumber(t) && e.length > t ? (sdLog("\u5b57\u7b26\u4e32\u957f\u5ea6\u8d85\u8fc7\u9650\u5236\uff0c\u5df2\u7ecf\u505a\u622a\u53d6--" + e), e.slice(0, t)) : e
}

function filterReservedProperties(e) {
  isObject(e) && each(["distinct_id", "user_id", "id", "date", "datetime", "event", "events", "first_id", "original_id", "device_id", "properties", "second_id", "time", "users"], function (t, r) {
    t in e && (r < 3 ? (delete e[t], sdLog("\u60a8\u7684\u5c5e\u6027- " + t + "\u662f\u4fdd\u7559\u5b57\u6bb5\uff0c\u6211\u4eec\u5df2\u7ecf\u5c06\u5176\u5220\u9664")) : sdLog("\u60a8\u7684\u5c5e\u6027- " + t + "\u662f\u4fdd\u7559\u5b57\u6bb5\uff0c\u8bf7\u907f\u514d\u5176\u4f5c\u4e3a\u5c5e\u6027\u540d"))
  })
}
...
function formatData(e) {
  var t = e.properties;
  isObject(t) ? (strip_sa_properties(t), filterReservedProperties(t), searchZZAppStyle(e), formatProperties(t), searchObjString(t)) : "properties" in e && (e.properties = {}), searchObjDate(e), formatItem(e)
}
var dataStageImpl$1 = {
  init: function () {},
  interceptor: {
...
var preCfg = window.sensors_data_pre_config,
  is_compliance_enabled = !!isObject(preCfg) && preCfg.is_compliance_enabled;

function implementCore(e) {
  e && (logger.setup(sdLog), sd._ = extend(W, common), sd.ee = ee, sd.sendState = sendState, sd.events = new sd._.EventEmitterSa, sd.batchSend = batchSend, sd.bridge = bridge, sd.SDKJSBridge = SDKJSBridge, sd.JSBridge = DeprecatedJSBridge, sd.store = store, sd.vtrackBase = vtrackBase, sd.unlimitedDiv = unlimitedDiv, sd.customProp = customProp, sd.vtrackcollect = vtrackcollect, sd.vapph5collect = vapph5collect, sd.heatmap = heatmap, sd.detectMode = detectMode, sd.registerFeature = registerFeature, sd.registerInterceptor = registerInterceptor, registerFeature(new CoreFeature(sd)), registerFeature(new DataFormatFeature(sd)));
  var t = e ? functions : saEmpty;
  for (var r in t) sd[r] = t[r];
  sd.on = eventEmitterFacade, sd.ee = ee, sd.use = use
}
sd.init = function (e) {
  if (ee.sdk.emit("beforeInit"), sd.readyState && sd.readyState.state && sd.readyState.state >= 2) return !1;
  is_compliance_enabled && implementCore(!0), ee.initSystemEvent(), sd.setInitVar(), sd.readyState.setState(2), sd.initPara(e), ee.sdk.emit("afterInitPara"), sd.detectMode(), sd.iOSWebClickPolyfill(), ee.sdk.emit("afterInit")
}, is_compliance_enabled ? implementCore(!1) : (implementCore(!0), checkState());
var _sd = sd;
try {
  sd.modules = {}, sd.modules.Amp = function () {
      "use strict";
      var e = {
        sd: null,
        init: function (e) {
      ...
      var e, t, r, i = {
        ...
        init: function (i) {
          ...
          function s() {
            if (e = t._, r = t.store, !e.localStorage.isSupport()) return !1;
            t.para.max_string_length = 1024, n.eventList.init(), n.addLatestChannelUrl(), n.addIsChannelCallbackEvent()
          }(t = i).on && t.readyState.state < 3 ? t.on("sdkAfterInitPara", s) : s()
        },
        ...
        addLatestChannelUrl: function () {
          ...
          if ("url\u89e3\u6790\u5931\u8d25" === r) this.registerAndSave({
            ...
            e.isString(s) && s.length > 0 ? (this.registerAndSave({
      ...
      var i = {
        ...
        a = {
          ...
          init: function () {
            ...
            if (s(sensorsDataAnalytic201505) && (this.sd = sensorsDataAnalytic201505), this.log("init()"), null === this.sd) return this.log("\u795e\u7b56JS SDK\u672a\u6210\u529f\u5f15\u5165"), !1;
            var e = {};
            if (arguments.length > 0 && (1 === arguments.length && s(arguments[0]) ? e = arguments[0] : arguments.length >= 2 && s(arguments[1]) && (e = arguments[1])), !i.hasOwnProperty(n)) return this.log("\u4e0d\u652f\u6301\u5f53\u524d\u7cfb\u7edf\uff0c\u76ee\u524d\u53ea\u652f\u6301Android\u548ciOS"), !1;
            if (s(e) && this.sd._.isNumber(e.timeout) && e.timeout >= 2500 && (this.timeout = e.timeout), !this.sd.para.server_url) return this.log("\u795e\u7b56JS SDK\u914d\u7f6e\u9879server_url\u672a\u6b63\u786e\u914d\u7f6e"), !1;
            var t, r, o = (t = this.sd, {
            ...
            var d = this.sd._.getQueryParam(window.location.href, "deeplink");
            ...
            this.key = c[2], this.apiURL = this.apiURL.replace("{key}", window.encodeURIComponent(c[2])), this.sd._.ajax({
              ...
              credentials: !1,
              success: function (e) {
                if (e.errorMsg) return a.log("API\u62a5\u9519\uff1a" + e.errorMsg), !1;
                a.data = e, a.log("API\u67e5\u8be2\u6210\u529f\uff0c\u6570\u636e\uff1a" + JSON.stringify(e, null, "  ")), this.data.app_key && (this.data.android_info && this.data.android_info.url_schemes && (this.data.android_info.url_schemes += "://sensorsdata/sd/" + this.data.app_key + "/" + this.key), this.data.ios_info && this.data.ios_info.url_schemes && (this.data.ios_info.url_schemes += "://sensorsdata/sd/" + this.data.app_key + "/" + this.key))
              }.bind(this),
              error: function () {
                a.log("API\u67e5\u8be2\u51fa\u9519")
              }
          ...
          openDeepLink: function () {
            ...
            if ("iOS" === n) {
              ...
              this.log("\u5524\u8d77APP\u7684\u5730\u5740\uff1a" + t), i = this, s = t, a = this.data.ios_info.download_url, i.log("\u5c1d\u8bd5\u5524\u8d77 iOS app:" + s), window.location.href = s, i.timer = setTimeout(function () {
                if (r()) return i.log("The page is hidden, stop navigating to download page"), !1;
                i.log("App\u53ef\u80fd\u672a\u5b89\u88c5\uff0c\u8df3\u8f6c\u5230\u4e0b\u8f7d\u5730\u5740"), window.location.href = a
              }, i.timeout), i.log("new timer:" + i.timer)
            } else this.log("\u5f53\u524d\u7cfb\u7edf\u662f android"),
              function (t, i, n) {
                t.log("\u5c1d\u8bd5\u5524\u8d77 android app");
                var s = i;
                t.log("\u5524\u8d77APP\u7684\u5730\u5740\uff1a" + s), window.location = s, t.timer = setTimeout(function () {
                  var i = r();
                  if (t.log("hide:" + e + ":" + document[e]), i) return t.log("The page is hidden, stop navigating to download page"), !1;
                  t.log("App\u53ef\u80fd\u672a\u5b89\u88c5\uff0c\u8df3\u8f6c\u5230\u4e0b\u8f7d\u5730\u5740"), window.location = n
                }, t.timeout)
      ...
      return s(window.SensorsDataWebJSSDKPlugin) ? (window.SensorsDataWebJSSDKPlugin.Deeplink = window.SensorsDataWebJSSDKPlugin.Deeplink || a, window.SensorsDataWebJSSDKPlugin.deeplink = window.SensorsDataWebJSSDKPlugin.deeplink || a) : window.SensorsDataWebJSSDKPlugin = {
        Deeplink: a,
        deeplink: a
      }, a
      ...
      e.prototype.init = function (e, t) {
        ...
        this.start_time = +new Date, !0 == !document.hidden ? this.page_show_status = !0 : this.page_show_status = !1, this.url = location.href
        ...
        for (var e = window.localStorage.length - 1; e >= 0; e--) {
          ...
          if (t && t !== this.storage_name + "-" + this.page_id && 0 === t.indexOf(this.storage_name + "-")) {
            ...
            this._.isObject(r) && 1 * new Date - r.time > r.heartbeat_interval_time + 5e3 && (delete r.heartbeat_interval_time, this.sd.kit.sendData(r), this.delHeartBeatData(t))
          }
        }
      ...
      var t = new e;
      return window.SensorsDataWebJSSDKPlugin && "[object Object]" === Object.prototype.toString.call(window.SensorsDataWebJSSDKPlugin) ? window.SensorsDataWebJSSDKPlugin.PageLeave = window.SensorsDataWebJSSDKPlugin.PageLeave || t : window.SensorsDataWebJSSDKPlugin = {
        PageLeave: t
      }, t
      ...
      var e = {
        init: function (e) {
          function t() {
            ...
            if (r && r.timing) {
              var s = r.timing;
              0 === s.fetchStart || 0 === s.domContentLoadedEventEnd ? e.log("performance \u6570\u636e\u83b7\u53d6\u5f02\u5e38") : i = s.domContentLoadedEventEnd - s.fetchStart,
                function (t, r) {
                  if (t.getEntries && "function" == typeof t.getEntries) {
                    for (var i = t.getEntries(), n = null, s = 0; s < i.length; s++) "transferSize" in i[s] && (n += i[s].transferSize);
                    e._.isNumber(n) && n >= 0 && n < 10737418240 && (r.$page_resource_size = Number((n / 1024).toFixed(3)))
                  }
                }(r, n)
            } else e.log("\u6d4f\u89c8\u5668\u672a\u652f\u6301 performance API.");
            i > 0 && (n.event_duration = Number((i / 1e3).toFixed(3))), e.track("$WebPageLoad", n), window.removeEventListener ? window.removeEventListener("load", t) : window.detachEvent && window.detachEvent("onload", t)
          }
      ...
      function e(e) {
        var t = this;
        this.sd = e.sd, this.currentProps = e.customRegister, this.interceptor = {
          addCustomProps: {
            priority: 0,
            entry: function (e) {
              return function (e, t) {
                ...
                var r = t.sd,
                  ...
                  c = {};
                i.each(a, function (e) {
                  if (i.isObject(e)) e.events.indexOf(d) > -1 && n({
      ...
      function t(t) {
        this.dataStage = new e(t)
      }

      function r() {
        this.sd = null, this.log = window.console && window.console.log || function () {}, this.customRegister = []
      }
      e.prototype.init = function () {}, r.prototype.init = function (e) {
        e ? (this.sd = e, this._ = e._, this.log = e.log, e.registerFeature(new t(this))) : this.log("\u795e\u7b56JS SDK\u672a\u6210\u529f\u5f15\u5165")
      ...
      }, r.prototype.hookRegister = function (e) {
      ...
      var i = new r;
      return i.__constructor__ = r, window.SensorsDataWebJSSDKPlugin && "[object Object]" === Object.prototype.toString.call(window.SensorsDataWebJSSDKPlugin) ? window.SensorsDataWebJSSDKPlugin.RegisterProperties = window.SensorsDataWebJSSDKPlugin.RegisterProperties || i : window.SensorsDataWebJSSDKPlugin = {
        RegisterProperties: i
      }, i
    }(), sd.modules.RegisterPropertyPageHeight = function () {
      "use strict";
      var e, t, r = window.console && window.console.log || function () {};

      function i(i) {
        try {
          if ("$pageview" !== i.event && (!i.type || "profile" !== i.type.slice(0, 7))) {
            var n = window.innerHeight || document.documentElement.clientHeight || document.body.clientHeight || 0,
              ...
              a = {
                $page_height: Math.max(n, s) || 0
              };
            i.properties = e._.extend(i.properties || {}, a)
          }
        } catch (o) {
          r("\u9875\u9762\u9ad8\u5ea6\u83b7\u53d6\u5f02\u5e38\u3002")
        }
        return t.call(e.kit, i)
      }
      var n = {
        init: function (n) {
          r = (e = n) && e.log || r, n && n.kit && n.kit.buildData ? (t = e.kit.buildData, e.kit.buildData = i, r("RegisterPropertyPageHeight \u63d2\u4ef6\u521d\u59cb\u5316\u5b8c\u6210")) : r("RegisterPropertyPageHeight \u63d2\u4ef6\u521d\u59cb\u5316\u5931\u8d25,\u5f53\u524d\u4e3bsdk\u4e0d\u652f\u6301 RegisterPropertyPageHeight \u63d2\u4ef6\uff0c\u8bf7\u5347\u7ea7\u4e3bsdk")
        }
      };
    ...
    function () {
      ...
      var e = {
        ...
        rewriteUrl: function (e, t) {
          ...
          if (i) {
            ...
            if (this.getPartHash(e)) s = d.indexOf("_sasdk"), n = d.indexOf("?") > -1 ? s > -1 ? a + o + "#" + d.substring(1, s) + l(d.substring(s, d.length)) : a + o + d + "&" + c : a + o + "#" + d.substring(1) + "?" + c;
            else s = o.indexOf("_sasdk"), n = /^\?(\w)+/.test(o) ? s > -1 ? a + "?" + l(o.substring(1)) + d : a + o + "&" + c + d : a + "?" + c + d;
            return t && (t.href = n), n
          }
        },
        getUrlId: function () {
          ...
          var e = this,
            t = function (t) {
              var r, i, n = t.target,
                ...
                a = n.parentNode;
              if ("a" === s && n.href || a && a.tagName && "a" === a.tagName.toLowerCase() && a.href) {
                "a" === s && n.href ? (r = n.href, i = n) : (r = a.href, i = a);
      ...
      "use strict";
      var e = window.SensorsData_App_Visual_Bridge,
        t = e && e.sensorsdata_visualized_mode,
        r = e && e.sensorsdata_visualized_alert_info,
        i = e && e.sensorsdata_hover_web_nodes;

      function n(r) {
        return t.call(e) && i && i.call(e, JSON.stringify(r))
      }
      var s, a, o, d, c, l, u = {
          isVerify: function () {
            return t && (!0 === t || t.call(e))
          },
          commands: {
            app_alert: function (t) {
              return r && r.call(e, JSON.stringify(t))
            },
            visualized_track: n,
            page_info: n,
            sensorsdata_get_app_visual_config: function (e, t) {
        ...
        p = {
          init: function (e) {
            c = (d = e) && d._, l = d && d.log || console && console.log || function () {}, d.on && d.on("sdkAfterInitPara", g)
          },
          handleCommand: function (e) {
            var t = e.callType;
            if (t in u.commands) return u.commands[t](e, s);
            s && c.isFunction(s.sensorsdata_js_call_app) && s.sensorsdata_js_call_app(JSON.stringify(e))
          }
        };

      function g() {
        s = window.SensorsData_APP_New_H5_Bridge, a = s && s.sensorsdata_track, o = a && s.sensorsdata_get_server_url && s.sensorsdata_get_server_url(), d && !d.bridge.activeBridge && o && (d.bridge.activeBridge = p, d.para.app_js_bridge && !d.para.app_js_bridge.is_mui && (d.bridge.is_verify_success = o && d.bridge.validateAppUrl(o)), d.bridge.bridge_info = {
          touch_app_bridge: !0,
          platform: "android",
          verify_success: d.bridge.is_verify_success ? "success" : "fail",
          support_two_way_call: !!s.sensorsdata_js_call_app
        }, d.para.app_js_bridge ? (d.registerInterceptor("sendStage", {
          send: {
            priority: 0,
            entry: f
          }
        }), l("Android bridge inits succeed.")) : l("app_js_bridge is not configured, data will not be sent by android bridge."))
      }

      function f(e, t) {
        if (d.para.app_js_bridge.is_mui) return e;
        var r = e.callback;
        return d.bridge.is_verify_success ? (a && a.call(s, JSON.stringify(c.extend({
          server_url: d.para.server_url
        }, e.data))), c.isFunction(r) && r(), t.cancellationToken.cancel(), e) : d.para.app_js_bridge.is_send ? (d.debug.apph5({
          data: e.data,
          step: "4.2",
          output: "all"
        }), e) : (c.isFunction(r) && r(), t.cancellationToken.cancel(), e)
      }
      return window.SensorsDataWebJSSDKPlugin && "[object Object]" === Object.prototype.toString.call(window.SensorsDataWebJSSDKPlugin) ? window.SensorsDataWebJSSDKPlugin.AndroidBridge = window.SensorsDataWebJSSDKPlugin.AndroidBridge || p : window.SensorsDataWebJSSDKPlugin = {
        AndroidBridge: p
      }, p
      ...
      var s, a, o, d, c, l, u, p = {
        ...
        g = {
          init: function (e) {
            l = (c = e) && c._, u = c && c.log || console && console.log || function () {}, c.on && c.on("sdkAfterInitPara", f)
          },
          handleCommand: function (e) {
            var t = e.callType;
            if (t in p.commands) return p.commands[t](e, s);
            if (s && l.isFunction(s.sensorsdata_js_call_app)) return s.sensorsdata_js_call_app(JSON.stringify(e))
          }
        };

      function f() {
        if (s = window.SensorsData_APP_JS_Bridge, a = s && s.sensorsdata_track, o = s && s.sensorsdata_verify, d = s && s.sensorsdata_visual_verify, c && !c.bridge.activeBridge && (o || a || d)) {
          c.bridge.activeBridge = g;
          var e = o || a;
          d && (e = !!d.call(s, JSON.stringify({
            server_url: c.para.server_url
          }))), c.bridge.bridge_info = {
            touch_app_bridge: !0,
            platform: "android",
            verify_success: e ? "success" : "fail"
          }, c.para.app_js_bridge ? (c.registerInterceptor("sendStage", {
            send: {
              priority: 0,
              entry: _
            }
          }), u("Android obsolete bridge inits succeed.")) : u("app_js_bridge is not configured, data will not be sent by android obsolete bridge.")
        }
      }
      ...
      function _(e, t) {
        ...
        var r = e.callback;
        return o ? o && o.call(s, JSON.stringify(l.extend({
          server_url: c.para.server_url
        }, e.data))) ? (l.isFunction(r) && r(), t.cancellationToken.cancel(), e) : c.para.app_js_bridge.is_send ? (c.debug.apph5({
          data: e.data,
          step: "3.1",
          output: "all"
        }), e) : (l.isFunction(r) && r(), t.cancellationToken.cancel(), e) : (a && a.call(s, JSON.stringify(l.extend({
          server_url: c.para.server_url
        }, e.data))), l.isFunction(r) && r(), t.cancellationToken.cancel(), e)
      }
      return window.SensorsDataWebJSSDKPlugin && "[object Object]" === Object.prototype.toString.call(window.SensorsDataWebJSSDKPlugin) ? window.SensorsDataWebJSSDKPlugin.AndroidObsoleteBridge = window.SensorsDataWebJSSDKPlugin.AndroidObsoleteBridge || g : window.SensorsDataWebJSSDKPlugin = {
        AndroidObsoleteBridge: g
      }, g
    }(), sd.modules.IosBridge = function () {
      "use strict";
      var e, t, r, i, n, s = {
        init: function (e) {
          i = (r = e) && r._, n = r && r.log || console && console.log || function () {}, r.on && r.on("sdkAfterInitPara", a)
        },
        handleCommand: function (e) {
          var n = e.callType;
          if (("page_info" === n || "visualized_track" === n) && !r.bridge.hasVisualModeBridge()) return null;
          if ("sensorsdata_get_app_visual_config" === n) return i.isObject(window.SensorsData_APP_New_H5_Bridge) && window.SensorsData_APP_New_H5_Bridge[n];
          return t() && t().postMessage(JSON.stringify(e))
        }
      };

      function a() {
        e = window.SensorsData_iOS_JS_Bridge && window.SensorsData_iOS_JS_Bridge.sensorsdata_app_server_url, t = function () {
          return window.webkit && window.webkit.messageHandlers && window.webkit.messageHandlers.sensorsdataNativeTracker
        }, r && !r.bridge.activeBridge && t() && t().postMessage && (r.bridge.activeBridge = s, r.para.app_js_bridge && !r.para.app_js_bridge.is_mui && (r.bridge.is_verify_success = e && r.bridge.validateAppUrl(e)), r.bridge.bridge_info = {
          touch_app_bridge: !0,
          platform: "ios",
          verify_success: r.bridge.is_verify_success ? "success" : "fail",
          support_two_way_call: !0
        }, r.para.app_js_bridge ? (r.registerInterceptor("sendStage", {
          send: {
            priority: 0,
            entry: o
          }
        }), n("IOS bridge inits succeed.")) : n("app_js_bridge is not configured, data will not be sent by iOS bridge."))
      }

      function o(e, n) {
        if (r.para.app_js_bridge.is_mui) return e;
        var s = e.callback;
        return r.bridge.is_verify_success ? (t() && t().postMessage(JSON.stringify({
          callType: "app_h5_track",
          data: i.extend({
            server_url: r.para.server_url
          }, e.data)
        })), i.isFunction(s) && s(), n.cancellationToken.cancel(), e) : r.para.app_js_bridge.is_send ? (r.debug.apph5({
          data: e.data,
          step: "4.1",
          output: "all"
        }), e) : (i.isFunction(s) && s(), n.cancellationToken.cancel(), e)
      }
      return window.SensorsDataWebJSSDKPlugin && "[object Object]" === Object.prototype.toString.call(window.SensorsDataWebJSSDKPlugin) ? window.SensorsDataWebJSSDKPlugin.IOSBridge = window.SensorsDataWebJSSDKPlugin.IOSBridge || s : window.SensorsDataWebJSSDKPlugin = {
        IOSBridge: s
      }, s
      ...
      var e, t, r, i = {
        init: function (i) {
          t = (e = i) && e._, r = e && e.log || console && console.log || function () {}, e.on && e.on("sdkAfterInitPara", n)
        }
      };

      function n() {
        !e || e.bridge.activeBridge || !/sensors-verify/.test(navigator.userAgent) && !/sa-sdk-ios/.test(navigator.userAgent) || window.MSStream || (e.bridge.activeBridge = i, e.bridge.bridge_info = {
          touch_app_bridge: !0,
          platform: "ios",
          verify_success: s() ? "success" : "fail"
        }, e.para.app_js_bridge ? (e.registerInterceptor("sendStage", {
          send: {
            priority: 0,
            entry: a
          }
        }), r("IOS obsolete bridge inits succeed.")) : r("app_js_bridge is not configured, data will not be sent by iOS obsolete bridge."))
      }
        ...
        if (/sensors-verify/.test(navigator.userAgent)) {
          ...
          if (r && r[0] && "string" == typeof r[1] && 2 === r[1].split("?").length) {
            ...
            var i = null,
              n = null;
            try {
              i = t.URL(e.para.server_url).hostname, n = t.URL(e.para.server_url).searchParams.get("project") || "default"
            } catch (s) {
              e.log(s)
            }
            return !(!i || i !== r[0] || !n || n !== r[1])
          }
          return !1
        }
      ...
      function a(r, i) {
        if (e.para.app_js_bridge.is_mui) return r;
        var n, s, a = r.callback;
        if (e.bridge.bridge_info.verify_success) {
          var o = document.createElement("iframe"),
            d = (n = r.data, s = (s = JSON.stringify(t.extend({
              server_url: e.para.server_url
            }, n))).replace(/\r\n/g, ""), "sensorsanalytics://trackEvent?event=" + (s = encodeURIComponent(s)));
          return o.setAttribute("src", d), document.documentElement.appendChild(o), o.parentNode.removeChild(o), o = null, t.isFunction(a) && a(), i.cancellationToken.cancel(), !0
        }
        return e.para.app_js_bridge.is_send ? (e.debug.apph5({
          data: r.data,
          step: "3.2",
          output: "all"
        }), r) : (t.isFunction(a) && a(), i.cancellationToken.cancel(), r)
      }
      return window.SensorsDataWebJSSDKPlugin && "[object Object]" === Object.prototype.toString.call(window.SensorsDataWebJSSDKPlugin) ? window.SensorsDataWebJSSDKPlugin.IOSObsoleteBridge = window.SensorsDataWebJSSDKPlugin.IOSObsoleteBridge || i : window.SensorsDataWebJSSDKPlugin = {
        IOSObsoleteBridge: i
      }, i
      ...
      var e, t = "utm_source utm_medium utm_campaign utm_content utm_term",
        r = {
          init: function (r) {
            r && !e && (e = r).on && e.on("sdkAfterInitPara", function () {
                  ...
                  entry: function () {
                    return function () {
                      var r = t.split(" "),
                        i = "",
                        n = {};
                      e._.isArray(e.para.source_channel) && e.para.source_channel.length > 0 && (r = r.concat(e.para.source_channel), r = e._.unique(r));
                      return e._.each(r, function (t) {
                        (i = e._.getQueryParam(location.href, t)).length && (n[t] = i)
                      }), n
                    }()
                  }
                }
    ...
    }(), sd.use("AndroidBridge"), sd.use("IOSBridge"), sd.use("AndroidObsoleteBridge"), sd.use("IOSObsoleteBridge"), sd.use("Utm"), "string" == typeof window.sensorsDataAnalytic201505 ? (sd.para = window[sensorsDataAnalytic201505].para, sd._q = window[sensorsDataAnalytic201505]._q, window[sensorsDataAnalytic201505] = sd, window.sensorsDataAnalytic201505 = sd, sd.init()) : "undefined" == typeof window.sensorsDataAnalytic201505 ? window.sensorsDataAnalytic201505 = sd : _sd = window.sensorsDataAnalytic201505
} catch (err) {
